...
public class ConductorDTO implements Serializable {
	...
	private static final Logger log = LoggerFactory.getLogger(ConductorDTO.class);
	...
	public Long getCiudadId_Ciudad1() {
		return ciudadId_Ciudad;
	}

	public void setCiudadId_Ciudad1(Long ciudadId_Ciudad) {
		this.ciudadId_Ciudad = ciudadId_Ciudad;
	}
}
