...
*
*/
public class DatProvicionesCierreNominaDTO implements Serializable {
    private static final long serialVersionUID = 1L;
    private static final Logger log = LoggerFactory.getLogger(DatProvicionesCierreNominaDTO.class);
    ...
    public Long getDatProvicionesCierreNominaId() {
        return datProvicionesCierreNominaId;
    }

    public void setDatProvicionesCierreNominaId(
        Long datProvicionesCierreNominaId) {
