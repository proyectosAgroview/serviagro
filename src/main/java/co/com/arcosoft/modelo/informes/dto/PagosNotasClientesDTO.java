...
public class PagosNotasClientesDTO {
	 private BigInteger dat_pagos_notas_clientes_id;
 ...
 private String concepto;
	...
	public BigInteger getDat_pagos_notas_clientes_id() {
	return dat_pagos_notas_clientes_id;
}
public void setDat_pagos_notas_clientes_id(BigInteger dat_pagos_notas_clientes_id) {
	this.dat_pagos_notas_clientes_id = dat_pagos_notas_clientes_id;
}
