...
public class ConsultaCompraProductosDTO {
	...
	private BigInteger consecutivoOt;
	private String nombreCentroCosto;
	private BigInteger dat_serv_realizados_equipo_id;
	private String consecutivoRdlTexto;
	private String id_detalle_rdl;
	...
	public String getConsecutivoRdlTexto() {
		return consecutivoRdlTexto;
	}
	public String getId_detalle_rdl() {
		return id_detalle_rdl;
	}
	public void setConsecutivoRdlTexto(String consecutivoRdlTexto) {
		this.consecutivoRdlTexto = consecutivoRdlTexto;
	}
	public void setId_detalle_rdl(String id_detalle_rdl) {
		this.id_detalle_rdl = id_detalle_rdl;
	}
	...
	public BigInteger getConsecutivoOt() {
		return consecutivoOt;
	}
	public void setConsecutivoOt(BigInteger consecutivoOt) {
		this.consecutivoOt = consecutivoOt;
	}
