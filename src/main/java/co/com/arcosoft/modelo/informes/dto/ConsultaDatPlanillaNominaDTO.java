 ...
 *
 */
public class ConsultaDatPlanillaNominaDTO implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(ConsultaDatPlanillaNominaDTO.class);
	private Long NPases;
	private Long anio;
