...
/**
 * DatProvicionesCierreNominaMq generated by hbm2java
 */
public class DatProvicionesCierreNominaMq implements java.io.Serializable {
	...
	public DatProvicionesCierreNominaMq() {
	}

	public DatProvicionesCierreNominaMq(Trabajador trabajador, ConceptoNomina conceptoNomina, Long compania,
			...
			Long usuarioDigitacion, Long centCostId) {
	...
	public Long getDatProvicionesCierreNominaMqId() {
		return this.datProvicionesCierreNominaMqId;
	}

	public void setDatProvicionesCierreNominaMqId(Long datProvicionesCierreNominaMqId) {
