...
@ManagedBean
@ViewScoped
public class InterfacePlanoNomina85View implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InterfacePlanoNomina85View.class);
	...
	private List<InterfaceNomina85DTO> data;
	...
	String filename = "C://ARCOSOFT/ERP/NMBATCH.DAT";

	public InterfacePlanoNomina85View() {
		super();
	}
	...
	public String action_informe1() {
		...
		if (data != null && data.size() > 0) {
			...
			FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "",
					"No existen datos para generar la interface INT_LIQUIDACION_CONTRATISTA"));
	...
	public void generarPlano() throws IOException {
		...
		List<InterfaceNomina85DTO> dto = data;
		...
		if (dto != null && dto.size() > 0) {
			...
			for (InterfaceNomina85DTO liquidacionContratistaDTO : dto) {
	...
	public List<InterfaceNomina85DTO> getData() {
		try {
			// Long compania = 1L;
			...
			if (compania != null) {
				...
				data = businessDelegatorView.consultarInterfaceNomina85(compania, fechaInicial, fechaFinal,
