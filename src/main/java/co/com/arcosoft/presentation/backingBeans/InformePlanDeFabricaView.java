...
@ManagedBean
@ViewScoped
public class InformePlanDeFabricaView  implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InformePlanDeFabricaView .class);
	...
	private List<MttoPlanFabricaDTO> data;
	...
	public InformePlanDeFabricaView () {
		super();
	}
	...
	public String exportToPyGExcel() {
		...
		Long anioInicial = Long.parseLong(anio.format(fechaInicial));
        Long anioFinal = Long.parseLong(anio.format(fechaFinal));  
		...
		if (compania != null) {
			try {
				...
				List<MttoPlanFabricaDTO> data = null;
				...
				filename = servletContext.getRealPath("") + File.separator + "informes" + File.separator
						+ "MttoReportePlanDeFabrica.xlsx";

				data = businessDelegatorView.consultarInformePlanFabrica(compania, anioInicial, anioFinal);
				...
				try {
					...
					if (data != null) {
						...
						cell = row.createCell(	0	);	cell.setCellValue("Dat_plan_anual_fabrica_id");	cell.setCellStyle(style2);
						cell = row.createCell(	1	);	cell.setCellValue("Consecutivo");	cell.setCellStyle(style2);
						cell = row.createCell(	2	);	cell.setCellValue("Anio");	cell.setCellStyle(style2);
						cell = row.createCell(	3	);	cell.setCellValue("Horas_arranque");	cell.setCellStyle(style2);
						cell = row.createCell(	4	);	cell.setCellValue("Produccion_est_enero");	cell.setCellStyle(style2);
						cell = row.createCell(	5	);	cell.setCellValue("Produccion_est_febrero");	cell.setCellStyle(style2);
						cell = row.createCell(	6	);	cell.setCellValue("Produccion_est_marzo");	cell.setCellStyle(style2);
						cell = row.createCell(	7	);	cell.setCellValue("Produccion_est_abril");	cell.setCellStyle(style2);
						cell = row.createCell(	8	);	cell.setCellValue("Produccion_est_mayo");	cell.setCellStyle(style2);
						cell = row.createCell(	9	);	cell.setCellValue("Produccion_est_junio");	cell.setCellStyle(style2);
						cell = row.createCell(	10	);	cell.setCellValue("Produccion_est_julio");	cell.setCellStyle(style2);
						cell = row.createCell(	11	);	cell.setCellValue("Produccion_est_agosto");	cell.setCellStyle(style2);
						cell = row.createCell(	12	);	cell.setCellValue("Produccion_est_septiembre");	cell.setCellStyle(style2);
						cell = row.createCell(	13	);	cell.setCellValue("Produccion_est_octubre");	cell.setCellStyle(style2);
						cell = row.createCell(	14	);	cell.setCellValue("Produccion_est_noviembre");	cell.setCellStyle(style2);
						cell = row.createCell(	15	);	cell.setCellValue("Produccion_est_diciembre");	cell.setCellStyle(style2);
						cell = row.createCell(	16	);	cell.setCellValue("Produccion_est_total");	cell.setCellStyle(style2);
						cell = row.createCell(	17	);	cell.setCellValue("Produccion_enero");	cell.setCellStyle(style2);
						cell = row.createCell(	18	);	cell.setCellValue("Produccion_febrero");	cell.setCellStyle(style2);
						cell = row.createCell(	19	);	cell.setCellValue("Produccion_marzo");	cell.setCellStyle(style2);
						cell = row.createCell(	20	);	cell.setCellValue("Produccion_abril");	cell.setCellStyle(style2);
						cell = row.createCell(	21	);	cell.setCellValue("Produccion_mayo");	cell.setCellStyle(style2);
						cell = row.createCell(	22	);	cell.setCellValue("Produccion_junio");	cell.setCellStyle(style2);
						cell = row.createCell(	23	);	cell.setCellValue("Produccion_julio");	cell.setCellStyle(style2);
						cell = row.createCell(	24	);	cell.setCellValue("Produccion_agosto");	cell.setCellStyle(style2);
						cell = row.createCell(	25	);	cell.setCellValue("Produccion_septiembre");	cell.setCellStyle(style2);
						cell = row.createCell(	26	);	cell.setCellValue("Produccion_octubre");	cell.setCellStyle(style2);
						cell = row.createCell(	27	);	cell.setCellValue("Produccion_noviembre");	cell.setCellStyle(style2);
						cell = row.createCell(	28	);	cell.setCellValue("Produccion_diciembre");	cell.setCellStyle(style2);
						cell = row.createCell(	29	);	cell.setCellValue("Produccion_total");	cell.setCellStyle(style2);
						cell = row.createCell(	30	);	cell.setCellValue("Velocidad_estandar");	cell.setCellStyle(style2);
						cell = row.createCell(	31	);	cell.setCellValue("Horas_proceso_est");	cell.setCellStyle(style2);
						cell = row.createCell(	32	);	cell.setCellValue("Horas_proceso_ejec");	cell.setCellStyle(style2);
						cell = row.createCell(	33	);	cell.setCellValue("Horas_mtto_prog_est");	cell.setCellStyle(style2);
						cell = row.createCell(	34	);	cell.setCellValue("Horas_mtto_prog_ejec");	cell.setCellStyle(style2);
						cell = row.createCell(	35	);	cell.setCellValue("Horas_mtto_no_prog_est");	cell.setCellStyle(style2);
						cell = row.createCell(	36	);	cell.setCellValue("Horas_mtto_no_prog_ejec");	cell.setCellStyle(style2);
						cell = row.createCell(	37	);	cell.setCellValue("Horas_planta_est");	cell.setCellStyle(style2);
						cell = row.createCell(	38	);	cell.setCellValue("Horas_planta_ejec");	cell.setCellStyle(style2);
						cell = row.createCell(	39	);	cell.setCellValue("Valor_promedio_hr_dia");	cell.setCellStyle(style2);
						cell = row.createCell(	40	);	cell.setCellValue("Nom_compania");	cell.setCellStyle(style2);
						cell = row.createCell(	41	);	cell.setCellValue("Observacion");	cell.setCellStyle(style2);

						
						int pos_i = 1;

						for (MttoPlanFabricaDTO ndDTO : data) {

							row = sheet.createRow(pos_i);

							cell = row.createCell(0	);	cell.setCellValue(ndDTO.getDat_plan_anual_fabrica_id().doubleValue());
							cell = row.createCell(1	);	cell.setCellValue(ndDTO.getConsecutivo().doubleValue());
							cell = row.createCell(2	);	cell.setCellValue(ndDTO.getAnio().doubleValue());
							cell = row.createCell(3	);	cell.setCellValue(ndDTO.getHoras_arranque().doubleValue());
							cell = row.createCell(4	);	cell.setCellValue(ndDTO.getProduccion_est_enero().doubleValue());
							cell = row.createCell(5	);	cell.setCellValue(ndDTO.getProduccion_est_febrero().doubleValue());
							cell = row.createCell(6	);	cell.setCellValue(ndDTO.getProduccion_est_marzo().doubleValue());
							cell = row.createCell(7	);	cell.setCellValue(ndDTO.getProduccion_est_abril().doubleValue());
							cell = row.createCell(8	);	cell.setCellValue(ndDTO.getProduccion_est_mayo().doubleValue());
							cell = row.createCell(9	);	cell.setCellValue(ndDTO.getProduccion_est_junio().doubleValue());
							cell = row.createCell(10	);	cell.setCellValue(ndDTO.getProduccion_est_julio().doubleValue());
							cell = row.createCell(11	);	cell.setCellValue(ndDTO.getProduccion_est_agosto().doubleValue());
							cell = row.createCell(12	);	cell.setCellValue(ndDTO.getProduccion_est_septiembre().doubleValue());
							cell = row.createCell(13	);	cell.setCellValue(ndDTO.getProduccion_est_octubre().doubleValue());
							cell = row.createCell(14	);	cell.setCellValue(ndDTO.getProduccion_est_noviembre().doubleValue());
							cell = row.createCell(15	);	cell.setCellValue(ndDTO.getProduccion_est_diciembre().doubleValue());
							cell = row.createCell(16	);	cell.setCellValue(ndDTO.getProduccion_est_total().doubleValue());
							cell = row.createCell(17	);	cell.setCellValue(ndDTO.getProduccion_enero().doubleValue());
							cell = row.createCell(18	);	cell.setCellValue(ndDTO.getProduccion_febrero().doubleValue());
							cell = row.createCell(19	);	cell.setCellValue(ndDTO.getProduccion_marzo().doubleValue());
							cell = row.createCell(20	);	cell.setCellValue(ndDTO.getProduccion_abril().doubleValue());
							cell = row.createCell(21	);	cell.setCellValue(ndDTO.getProduccion_mayo().doubleValue());
							cell = row.createCell(22	);	cell.setCellValue(ndDTO.getProduccion_junio().doubleValue());
							cell = row.createCell(23	);	cell.setCellValue(ndDTO.getProduccion_julio().doubleValue());
							cell = row.createCell(24	);	cell.setCellValue(ndDTO.getProduccion_agosto().doubleValue());
							cell = row.createCell(25	);	cell.setCellValue(ndDTO.getProduccion_septiembre().doubleValue());
							cell = row.createCell(26	);	cell.setCellValue(ndDTO.getProduccion_octubre().doubleValue());
							cell = row.createCell(27	);	cell.setCellValue(ndDTO.getProduccion_noviembre().doubleValue());
							cell = row.createCell(28	);	cell.setCellValue(ndDTO.getProduccion_diciembre().doubleValue());
							cell = row.createCell(29	);	cell.setCellValue(ndDTO.getProduccion_total().doubleValue());
							cell = row.createCell(30	);	cell.setCellValue(ndDTO.getVelocidad_estandar().doubleValue());
							cell = row.createCell(31	);	cell.setCellValue(ndDTO.getHoras_proceso_est().doubleValue());
							cell = row.createCell(32	);	cell.setCellValue(ndDTO.getHoras_proceso_ejec().doubleValue());
							cell = row.createCell(33	);	cell.setCellValue(ndDTO.getHoras_mtto_prog_est().doubleValue());
							cell = row.createCell(34	);	cell.setCellValue(ndDTO.getHoras_mtto_prog_ejec().doubleValue());
							cell = row.createCell(35	);	cell.setCellValue(ndDTO.getHoras_mtto_no_prog_est().doubleValue());
							cell = row.createCell(36	);	cell.setCellValue(ndDTO.getHoras_mtto_no_prog_ejec().doubleValue());
							cell = row.createCell(37	);	cell.setCellValue(ndDTO.getHoras_planta_est().doubleValue());
							cell = row.createCell(38	);	cell.setCellValue(ndDTO.getHoras_planta_ejec().doubleValue());
							cell = row.createCell(39	);	cell.setCellValue(ndDTO.getValor_promedio_hr_dia().doubleValue());
							cell = row.createCell(40	);	cell.setCellValue(ndDTO.getNom_compania());
							cell = row.createCell(41	);	cell.setCellValue(ndDTO.getObservacion());
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "MttoReportePlanDeFabrica.xlsx");
	...
	public List<MttoPlanFabricaDTO> getData() {
		try {
			if (data == null) {
				data = businessDelegatorView.consultarInformePlanFabrica(null, null, null);
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
