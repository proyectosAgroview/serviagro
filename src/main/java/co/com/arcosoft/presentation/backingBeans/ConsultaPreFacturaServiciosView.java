...
@ManagedBean
@ViewScoped
public class ConsultaPreFacturaServiciosView implements Serializable {
    private static final long serialVersionUID = 1L;
    private static final Logger log = LoggerFactory.getLogger(ConsultaPreFacturaServiciosView.class);
    ...
    private InputText txtNumPrefactura;
    ...
    public ConsultaPreFacturaServiciosView() {
        super();
    }
    ...
    public String actionReversarPreFactura() {
        try {
        	...
        	FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "",
					"La prefactura fue reversada exitosamente"));
    ...
    public void action_saveReversarServicios() {
        try {
        	...
        	setShowDialog(true);
			    //	Long datFacturaServicio = businessDelegatorView.pr_borrar_factura_servicio_consolidada(numPreFactura);
		        //	Long reversa = businessDelegatorView.pr_reversar_prefactura_servicio(clienteId2, numPreFactura) ;
...
//            entity.setDatFacturaServiciosId(datFacturaServiciosId);
			...
			{	
				if(valor_factura>0){
					Long actualizar_dat_servDet=  businessDelegator2View.actualizarNumFacturaEnDatServRDet(cadenaFactura, num_factura);
    ...
    public String action_modify() {
        try {
            if (entityServiciosDet == null) {
                Long datServRealizadosEquipoDetId = new Long(selectedDatServRealizadosEquipo3.getIdRegistro().longValue());
 ...
 /*
            entityServiciosDet.setPersEmpr((FacesUtils.checkLong(txtPersEmprIdFormulario) != null)
  ...
  */
            entityServiciosDet.setNivel4ClientesId((FacesUtils.checkLong(txtNivel4ClientesId) != null)
                    ? businessDelegator2View.getNivel4Clientesmq(FacesUtils.checkLong(
                    		txtNivel4ClientesId)) : null);
            /*
 ...
 */
    ...
    public String action_delete_datatable(ActionEvent evt) {
        try {
            selectedDatFacturaServicios = (DatFacturaServiciosDTO) (evt.getComponent()
                                                                       .getAttributes()
    ...
    public String action_modifyWitDTO(Long compania, Long consecutivo,
        Long datFacturaServiciosId, String detalleFactura, String estado,
        Date fechaAnulacion, Date fechaCreacion, Date fechaRegistro,
        Date fechaVencimiento, String formaPago, Long numFactura,
        String observacion, String observacionAnularReg, Long persEmprId,
        Long plazo, Double retencion, Long usuarioDigitacion,
        Double valorBaseIva, Double valorDescuento,
        Double valorDescuentoCenicana, Double valorDescuentoTimbre,
        Double valorFactura, Double valorIva, Double valorReteIca,
        Double valorReteIva, Double valorRetencionContrato)
        throws Exception {
        try {
    ...
    public void setSelectedDatFacturaServicios(
        DatFacturaServiciosDTO datFacturaServicios) {
	...
	public InputText getTxtNumPrefactura() {
		return txtNumPrefactura;
	}

	public void setTxtNumPrefactura(InputText txtNumPrefactura) {
	...
	public String action_anularReg(ActionEvent evt) throws Exception {
		...
		action_clear();
		selectedDatFacturaServicios = (DatFacturaServiciosDTO) (evt.getComponent()
				.getAttributes().get("selectedDatFacturaServicios"));
		setShowDialog(true);
		...
		if (contratistaFormulario == null || contratistaFormulario.size() == 0) {
			...
			try {
				...
				for (PersEmpr contratistaFormulario : lista) {
					selectContratistaFormulario[i] = new SelectItem(contratistaFormulario.getPersEmprId(), contratistaFormulario.getNombre());
					i++;
    ...
    public String action_edit(ActionEvent evt) {
    	selectedDatServRealizadosEquipo3 = (ConsultaServiciosRealizadosMaquinariaDTO) (evt.getComponent().getAttributes()
				.get("selectedDatServRealizadosEquipo3"));
		try {
	...
	public void setSelectedDatServRealizadosEquipoDet(DatServRealizadosEquipoDetDTO selectedDatServRealizadosEquipoDet) {
	...
	public String action_actualizarServPrefacturados() {
		try {
 		 ...
 		 entityServiciosDet.setCantidad(FacesUtils.checkDouble(txtCantidad));
            ...
            entityServiciosDet.setNivel2ClientesId((FacesUtils.checkLong(txtNivel2ClientesId) != null)
                    ? businessDelegator2View.getNivel2Clientesmq(FacesUtils.checkLong(
                    		txtNivel2ClientesId)) : null);
			...
			try {
				...
				try {
					...
					if (data3 != null) {
						...
						cell = row.createCell(45	);	cell.setCellValue("DIRECCION_CLIENTE");	cell.setCellStyle(style2);
						cell = row.createCell(46	);	cell.setCellValue("TELEFONO_CLIENTE");	cell.setCellStyle(style2);
						...
						for (ConsultaServiciosRealizadosMaquinariaDTO ndDTO : data3) {
							...
							cell = row.createCell(2	);	cell.setCellValue(ndDTO.getCodEquipo());	cell.setCellStyle(style);
							cell = row.createCell(3	);	cell.setCellValue(ndDTO.getNomEquipo());	cell.setCellStyle(style);
							cell = row.createCell(4	);	cell.setCellValue(ndDTO.getCodFinca());	cell.setCellStyle(style);
							cell = row.createCell(5	);	cell.setCellValue(ndDTO.getNomFinca());	cell.setCellStyle(style);
							cell = row.createCell(6	);	cell.setCellValue(ndDTO.getNomLabor());	cell.setCellStyle(style);
							cell = row.createCell(7	);	cell.setCellValue(ndDTO.getCantidadPago().doubleValue());	cell.setCellStyle(style);
							cell = row.createCell(8	);	cell.setCellValue(ndDTO.getCodUdadMed());	cell.setCellStyle(style);
							cell = row.createCell(9	);	cell.setCellValue(ndDTO.getNomUdadMed());	cell.setCellStyle(style);
							cell = row.createCell(10	);	cell.setCellValue(ndDTO.getHoras().doubleValue());	cell.setCellStyle(style);
							cell = row.createCell(11	);	cell.setCellValue(ndDTO.getCodLote());	cell.setCellStyle(style);
							...
							cell = row.createCell(13	);	cell.setCellValue(ndDTO.getHoraInicial());	cell.setCellStyle(style);
							cell = row.createCell(14	);	cell.setCellValue(ndDTO.getHoraFinal());	cell.setCellStyle(style);
							cell = row.createCell(15	);	cell.setCellValue(ndDTO.getHorometroInicial().doubleValue());	cell.setCellStyle(style);
							cell = row.createCell(16	);	cell.setCellValue(ndDTO.getHorometroFinal().doubleValue());	cell.setCellStyle(style);
							cell = row.createCell(17	);	cell.setCellValue(ndDTO.getCodProducto());	cell.setCellStyle(style);
							cell = row.createCell(18	);	cell.setCellValue(ndDTO.getNomProducto());	cell.setCellStyle(style);
							cell = row.createCell(19	);	cell.setCellValue(ndDTO.getCantGalones().doubleValue());	cell.setCellStyle(style);
							cell = row.createCell(20	);	cell.setCellValue(ndDTO.getCodUdadMedIns());	cell.setCellStyle(style);
							cell = row.createCell(21	);	cell.setCellValue(ndDTO.getNomUdadMedIns());	cell.setCellStyle(style);
							cell = row.createCell(22	);	cell.setCellValue(ndDTO.getCostoCombustible().doubleValue());	cell.setCellStyle(style);
							cell = row.createCell(23	);	cell.setCellValue(ndDTO.getHorasEquipoDia().doubleValue());	cell.setCellStyle(style);
							cell = row.createCell(24	);	cell.setCellValue(ndDTO.getValorUnitario().doubleValue());	cell.setCellStyle(style);
							cell = row.createCell(25	);	cell.setCellValue(ndDTO.getCostoTotal().doubleValue());	cell.setCellStyle(style);
							cell = row.createCell(26	);	cell.setCellValue(ndDTO.getCodCliente());	cell.setCellStyle(style);
							cell = row.createCell(27	);	cell.setCellValue(ndDTO.getNomCliente());	cell.setCellStyle(style);
							cell = row.createCell(28	);	cell.setCellValue(ndDTO.getSello().doubleValue());	cell.setCellStyle(style);
							cell = row.createCell(29	);	cell.setCellValue(ndDTO.getTurno());	cell.setCellStyle(style);
							cell = row.createCell(30	);	cell.setCellValue(ndDTO.getCod_operario());	cell.setCellStyle(style);
							cell = row.createCell(31	);	cell.setCellValue(ndDTO.getNom_operario());	cell.setCellStyle(style);
							cell = row.createCell(32	);	cell.setCellValue(ndDTO.getCod_concepto_nomina());	cell.setCellStyle(style);
							cell = row.createCell(33	);	cell.setCellValue(ndDTO.getNom_concepto_nomina());	cell.setCellStyle(style);
							cell = row.createCell(34	);	cell.setCellValue(ndDTO.getBonificacion_trabajador().doubleValue());	cell.setCellStyle(style);
							cell = row.createCell(35	);	cell.setCellValue(ndDTO.getCod_implemento());	cell.setCellStyle(style);
							cell = row.createCell(36	);	cell.setCellValue(ndDTO.getNom_implemento());	cell.setCellStyle(style);
							...
							cell = row.createCell(39	);	cell.setCellValue(ndDTO.getDocFactura());	cell.setCellStyle(style);
							cell = row.createCell(40	);	cell.setCellValue(ndDTO.getCodLabor());	cell.setCellStyle(style);
							cell = row.createCell(41	);	cell.setCellValue(ndDTO.getPin().doubleValue());	cell.setCellStyle(style);
							cell = row.createCell(42	);	cell.setCellValue(ndDTO.getIdRegistro().doubleValue());	cell.setCellStyle(style);
							cell = row.createCell(43	);	cell.setCellValue(ndDTO.getEstatusRegistro());	cell.setCellStyle(style);
							cell = row.createCell(44	);	cell.setCellValue(ndDTO.getConsecutivoPrefactura().doubleValue());	cell.setCellStyle(style);
							cell = row.createCell(45	);	cell.setCellValue(ndDTO.getDireccionCliente());	cell.setCellStyle(style);
							cell = row.createCell(46	);	cell.setCellValue(ndDTO.getTelefonoCliente());	cell.setCellStyle(style);
						...
						filePreFactura = new DefaultStreamedContent(stream, "application/xlsx", "MttoSRPrefacturaConsulta.xlsx");
