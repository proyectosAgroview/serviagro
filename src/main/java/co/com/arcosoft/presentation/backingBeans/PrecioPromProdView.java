...
@ManagedBean
@ViewScoped
public class PrecioPromProdView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(PrecioPromProdView.class);
	...
	public String actionDeleteDataTableEditable(ActionEvent evt) {
		try {
			...
			Long precioProdId = new Long(selectedPrecioPromProd2.getPrecioProdid().longValue());
			entity = businessDelegatorView.getPrecioPromProd(precioProdId);
			businessDelegatorView.deletePrecioPromProd(entity);
	...
	public SelectItem[] getSelectEquipo() {
		...
		if (equipo == null || equipo.size() == 0) {
			...
			try {
				Object[] condicion = {  "origenDatos", true, "Modulo_TallerAgricola", "="
					};
