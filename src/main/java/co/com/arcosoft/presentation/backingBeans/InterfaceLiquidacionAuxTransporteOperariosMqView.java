...
@ManagedBean
@ViewScoped
public class InterfaceLiquidacionAuxTransporteOperariosMqView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InterfaceLiquidacionAuxTransporteOperariosMqView.class);
	...
	public InterfaceLiquidacionAuxTransporteOperariosMqView() {
		super();
	}
	...
	public Long calculoAuxilioTransporte() {
		try {
			// Long compania = 1L;
		...
		//	fechaFinal = (FacesUtils.checkDate(txtFechaFinal));		
			...
			if (compania != null && fechaInicial !=null && fechaFinal !=null) {
			    ...
			    if(diffDays == 13 || diffDays == 14 || diffDays == 15 ||diffDays == 16) {
					borrarNomina  = businessDelegator2View.pr_borrar_liq_transporte_operario(compania, fechaInicial, fechaFinal);
					 
					insertNomina = businessDelegator2View.pr_interfaz_liq_transporte_operario
							(compania, fechaInicial, fechaFinal, trabajadorSeleccionadas, flagTrabajador, equiposSeleccionadas, flagEquipo ); 
	
					FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, 
							"La interfaz de liquidación de auxilio de transporte de los  operarios fue ejecutada con éxito. ",
							""));
