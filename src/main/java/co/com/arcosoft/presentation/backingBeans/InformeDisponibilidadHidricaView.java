...
@ManagedBean
@ViewScoped
public class InformeDisponibilidadHidricaView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InformeDisponibilidadHidricaView.class);
	...
	public InformeDisponibilidadHidricaView() {
		super();
	}
