...
@ManagedBean
@ViewScoped
public class informeOtrosCostosIndirectosMqExcelView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(informeOtrosCostosIndirectosMqExcelView.class);
	...
	public informeOtrosCostosIndirectosMqExcelView() {
		super();
	}
		...
		if (compania != null) {
			try {
				...
				filename = servletContext.getRealPath("") + File.separator + "informes" + File.separator
						+ "OtrosCostosIndirectosMq.xlsx";

				data = businessDelegatorView.consultarCostosIndirectosMq(compania, fechaInicial, fechaFinal,
						contratistasSeleccionadas, flagContratista, laboresSeleccionadas, flagLabor);
				...
				try {
					...
					if (data != null) {
						...
						cell.setCellValue("COD. PROVEEDOR");
						cell.setCellStyle(style2);
						...
						cell.setCellValue("ELEMENTO DE COSTO");
						cell.setCellStyle(style2);
						...
						cell.setCellValue("ITEM DE SERVICIO");
						cell.setCellStyle(style2);
						...
						for (CostosIndirectosEquipoDTO ndDTO : data) {
							...
							cell = row.createCell(0);
							cell.setCellValue(ndDTO.getFecha().toString().substring(0, 10));
							...
							cell = row.createCell(6);
							cell.setCellValue(ndDTO.getNomElementoCosto());
							...
							cell = row.createCell(12);
							cell.setCellValue(ndDTO.getValorUnit().doubleValue());
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "OtrosCostosIndirectosMq.xlsx");
	...
	public List<CostosIndirectosEquipoDTO> getData() {
		try {
			if (data == null) {
				data = businessDelegatorView.consultarCostosIndirectosMq(1l, null, null, null, null, null, null);
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
