...
@ManagedBean
@ViewScoped
public class DatProvicionesCierreNominaMqView implements Serializable {
    ...
    private InputText atProvicionesCierreNominaMqId;
    ...
    private List<DatProvicionesCierreNominaMqDTO> data;
    private DatProvicionesCierreNominaMqDTO selectedDatProvicionesCierreNominaMq;
    private DatProvicionesCierreNominaMq entity;
    ...
    public DatProvicionesCierreNominaMqView() {
        super();
    }

    public String action_new() {
        action_clear();
        selectedDatProvicionesCierreNominaMq = null;
        setShowDialog(true);
    ...
    public String action_clear() {
        ...
        if (atProvicionesCierreNominaMqId != null) {
            atProvicionesCierreNominaMqId.setValue(null);
            atProvicionesCierreNominaMqId.setDisabled(false);
        }
    ...
    public String action_edit(ActionEvent evt) throws Exception {
        ...
        entity = businessDelegator2View.getDatProvicionesCierreNominaMq(selectedFiltro.getDatProvisionesCierreNominaId().longValue());
    ...
    public String action_save() {
        try {
            if ((selectedDatProvicionesCierreNominaMq == null) &&
                    (entity == null)) {
                action_create();
            } else {
                action_modify();
    ...
    public String action_create() {
        try {
            entity = new DatProvicionesCierreNominaMq();
            ...
            businessDelegator2View.saveDatProvicionesCierreNominaMq(entity);
    ...
    public String action_modify() {
        try {
            if (entity == null) {
                Long datProvicionesCierreNominaMqId = new Long(selectedDatProvicionesCierreNominaMq.getDatProvicionesCierreNominaMqId());
                entity = businessDelegator2View.getDatProvicionesCierreNominaMq(datProvicionesCierreNominaMqId);
            }
            ...
            businessDelegator2View.updateDatProvicionesCierreNominaMq(entity);
    ...
    public String action_delete_datatable(ActionEvent evt) {
        try {
            selectedDatProvicionesCierreNominaMq = (DatProvicionesCierreNominaMqDTO) (evt.getComponent()
                                                                                     .getAttributes()
                                                                                     .get("selectedDatProvicionesCierreNominaMq"));
    ...
    public String action_delete_master() {
        try {
            Long datProvicionesCierreNominaMqId = FacesUtils.checkLong(atProvicionesCierreNominaMqId);
            entity = businessDelegator2View.getDatProvicionesCierreNominaMq(datProvicionesCierreNominaMqId);
            action_delete();
        } catch (Exception e) {
            FacesUtils.addErrorMessage(e.getMessage());
    ...
    public void action_delete() throws Exception {
        try {
            businessDelegator2View.deleteDatProvicionesCierreNominaMq(entity);
    ...
    public String actionDeleteDataTableEditable(ActionEvent evt) {
        try {
            ...
            entity = businessDelegator2View.getDatProvicionesCierreNominaMq(datProvicionesCierreNominaMqId);
            businessDelegator2View.deleteDatProvicionesCierreNominaMq(entity);
            data.remove(selectedDatProvicionesCierreNominaMq);
            FacesUtils.addInfoMessage(ZMessManager.ENTITY_SUCCESFULLYDELETED);
            action_clear();
        } catch (Exception e) {
            FacesUtils.addErrorMessage(e.getMessage());
    ...
    public InputText getTxtDatProvicionesCierreNominaId() {
        return atProvicionesCierreNominaMqId;
    }

    public void setTxtDatProvicionesCierreNominaId(InputText atProvicionesCierreNominaMqId) {
        this.atProvicionesCierreNominaMqId = atProvicionesCierreNominaMqId;
    }

    public List<DatProvicionesCierreNominaMqDTO> getData() {
        try {
            if (data == null) {
                data = businessDelegator2View.getDataDatProvicionesCierreNominaMq();
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void setData(List<DatProvicionesCierreNominaMqDTO> datProvicionesCierreNominaMqDTO) {
        this.data = datProvicionesCierreNominaMqDTO;
    }

    public DatProvicionesCierreNominaMqDTO getSelectedDatProvicionesCierreNomina() {
        return selectedDatProvicionesCierreNominaMq;
    }

    public void setSelectedDatProvicionesCierreNomina(DatProvicionesCierreNominaMqDTO datProvicionesCierreNomina) {
        this.selectedDatProvicionesCierreNominaMq = datProvicionesCierreNomina;
    }
	...
	public void consultar() throws Exception {
		...
		if (fechaFinal != null && fechaInicial != null) {
			...
			dataFiltro = businessDelegator2View.pr_listar_proviciones_mq(compania, fechaInicial, fechaFinal, trabId, flagTrabajador);
		}
	}
