...
@ManagedBean
@ViewScoped
public class InformeDetalleInsumosLoteView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InformeDetalleInsumosLoteView.class);
	...
	private List<DetalleInsumosLoteDTO> data;
	...
	public InformeDetalleInsumosLoteView() {
		super();
	}
	...
	public List<DetalleInsumosLoteDTO> getData() {
		try {
			// Long compania = 1L;
			...
			if (compania != null) {
				...
				data = businessDelegatorView.consultaDetalleInsumosLoteDTO(compania, tiposProductoSeleccionadas,
						flagTipoProducto, productosSeleccionadas, flagProducto, almacenesSeleccionadas, flagAlmacen,
