...
@ManagedBean
@ViewScoped
public class InformeAnalisisEnfermedadView3Mapa implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InformeAnalisisEnfermedadView3Mapa.class);
	...
	private List<AnalisisEnfermedadDTO> data;
	...
	private String visibilityIndex0 = "hidden";
	private String visibilityIndex1 = "hidden";
/*	private boolean disabledPestañaIndex0 = true;
	private boolean disabledPestañaIndex1 = true;*/
	...
	public InformeAnalisisEnfermedadView3Mapa() {
...
/*
		if (this.estado_kml.equals("A")) {
			...
			this.disabledPestañaIndex0 = false;
			this.disabledPestañaIndex1 = true;
			this.NumeroPestaña = 0;

		} else {

			this.disabledPestañaIndex0 = true;
			this.disabledPestañaIndex1 = false;
			this.NumeroPestaña = 1;
		}*/
	...
	public void cargarConfiguracionMapa(Long companiaId) throws Exception, Exception {
		...
		if (this.estado_kml.equals("A")) {
			...
			FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "",
					"Ahora puedes seleccionar la pestaña (Mapa de plagas (KML)) para visualizar los resultados de la busqueda.."));

		} else {
*/
			FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "",
					"Ahora puedes seleccionar la pestaña (Mapa de plagas (Google Maps)) para visualizar los resultados de la busqueda.."));
			/*this.NumeroPestaña = 1;*/
	...
	public String action_consultar() throws Exception {
		...
		if (this.estado_kml.equals("A")) {
			...
			getAnalisisEnfermedadesGisGoogleMaps();
		}
		getData();
		return "";
	}
	...
	/*public int getNumeroPestaña() {
		return NumeroPestaña;
	}

	public void setNumeroPestaña(int numeroPestaña) {
		NumeroPestaña = numeroPestaña;
	}

	public boolean isDisabledPestañaIndex0() {
		return disabledPestañaIndex0;
	}

	public boolean isDisabledPestañaIndex1() {
		return disabledPestañaIndex1;
	}

	public void setDisabledPestañaIndex0(boolean disabledPestañaIndex0) {
		this.disabledPestañaIndex0 = disabledPestañaIndex0;
	}

	public void setDisabledPestañaIndex1(boolean disabledPestañaIndex1) {
		this.disabledPestañaIndex1 = disabledPestañaIndex1;
	}
*/
	...
	public List<AnalisisEnfermedadDTO> getData() {
		try {
			...
			if (compania != null && fechaInicial !=null && fechaFinal !=null) {
				...
				data = businessDelegatorView.consultarAnalisisEnfermedad(compania, fechaInicial, fechaFinal,
						zonasSeleccionadas, flagZona, fincasSeleccionadas, flagFinca, bloquesSeleccionadas, flagBloque,
	...
	public void setData(List<AnalisisEnfermedadDTO> data) {
		this.data = data;
	}
