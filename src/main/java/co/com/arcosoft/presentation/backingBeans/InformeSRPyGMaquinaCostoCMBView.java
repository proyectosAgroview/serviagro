...
@ManagedBean
@ViewScoped
public class InformeSRPyGMaquinaCostoCMBView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InformeSRPyGMaquinaCostoCMBView.class);
	...
	public InformeSRPyGMaquinaCostoCMBView() {
		super();
	}
	...
	public List<Equipo> getEquipos() {
		...
		try {
				...
				Object[] condicion = { "estado", true, "A", "=", 
						...
						"categoriaEquipo.funcion", true, "Camion", "<>",
						"categoriaEquipo.funcion", true, "Camioneta", "<>"
	...
	public void consultaPyGMaquianria() {
		try {
