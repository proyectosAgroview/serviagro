...
@ManagedBean
@ViewScoped
public class InformeSRIngresosVsCostoMaquinaView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InformeSRIngresosVsCostoMaquinaView.class);
	...
	public InformeSRIngresosVsCostoMaquinaView() {
		super();
	}
	...
	public void consultaIngresosVsCostos() throws NumberFormatException, Exception {
		...
		if (compania != null) {
			try {
				...
				filename = servletContext.getRealPath("") + File.separator + "informes" + File.separator
						+ "MttoSRIngresosVsCostosMaquina.xlsx";

				data = businessDelegator2View.pr_ingresos_vs_costos_maquina(compania,  fechaInicial, fechaFinal, 
						 equiposSeleccionadas, flagEquipo,categoriaEquiposSeleccionadas, flagEquipoCategoriaEquipos, estadoServicio, tipoMovimiento);
				...
				try {
					...
					if (data != null) {
						...
						cell = row.createCell(0	);	cell.setCellValue("COD EQUIPO");	cell.setCellStyle(style2);	
						cell = row.createCell(1	);	cell.setCellValue("NOM EQUIPO");	cell.setCellStyle(style2);	
						cell = row.createCell(2	);	cell.setCellValue("CANTIDAD PAGO");	cell.setCellStyle(style2);	
						cell = row.createCell(3);	cell.setCellValue("HORAS");	cell.setCellStyle(style2);	
						cell = row.createCell(4);	cell.setCellValue("INGRESO TOTAL");	cell.setCellStyle(style2);	
						cell = row.createCell(5);	cell.setCellValue("COSTO TOTAL");	cell.setCellStyle(style2);	
						cell = row.createCell(6);	cell.setCellValue("CONCEPTO GASTO");	cell.setCellStyle(style2);	
						cell = row.createCell(7);	cell.setCellValue("COMBUSTIBLE");	cell.setCellStyle(style2);	
						cell = row.createCell(8);	cell.setCellValue("COD. GRUPO GASTO");	cell.setCellStyle(style2);	
						cell = row.createCell(9);	cell.setCellValue("NOM. GRUPO GASTO");	cell.setCellStyle(style2);	
						cell = row.createCell(10);	cell.setCellValue("AÑO");	cell.setCellStyle(style2);	
						cell = row.createCell(11);	cell.setCellValue("MES");	cell.setCellStyle(style2);	
						cell = row.createCell(12);	cell.setCellValue("AÑO MES");	cell.setCellStyle(style2);	
						...
						for (ConsultaServiciosRealizadosMaquinariaDTO ndDTO : data) {
							...
							cell = row.createCell(0	);	cell.setCellValue(ndDTO.getCodEquipo());	
							cell = row.createCell(1	);	cell.setCellValue(ndDTO.getNomEquipo());	
							cell = row.createCell(2	);	cell.setCellValue(ndDTO.getCantidadPago().doubleValue());	
							cell = row.createCell(3	);	cell.setCellValue(ndDTO.getHoras().doubleValue());	
							cell = row.createCell(4	);	cell.setCellValue(ndDTO.getIngresoTotal().doubleValue());	
							cell = row.createCell(5	);	cell.setCellValue(ndDTO.getCostoTotal().doubleValue());
							cell = row.createCell(6	);	cell.setCellValue(ndDTO.getConceptoGasto());	
							cell = row.createCell(7	);	cell.setCellValue(ndDTO.getCombustible().doubleValue());	
							cell = row.createCell(8	);	cell.setCellValue(ndDTO.getCodGrupoGasto());	
							cell = row.createCell(9	);	cell.setCellValue(ndDTO.getNomGrupoGasto());	
							
							cell = row.createCell(10	);	cell.setCellValue(ndDTO.getAnio().doubleValue());	
							cell = row.createCell(11	);	cell.setCellValue(ndDTO.getMes().doubleValue());	
						
							cell = row.createCell(12	);	cell.setCellValue(ndDTO.getAnio_mes());	
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "MttoSRIngresosVsCostosMaquina.xlsx");
	...
	public List<PersEmpr> getClientes() {
		...
		if (clientes == null || clientes.size() == 0) {
			...
			clientes = new ArrayList<PersEmpr>();
