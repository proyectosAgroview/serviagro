...
@ManagedBean
@ViewScoped
public class InformeSRLiqManoObraMqExcelView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InformeSRLiqManoObraMqExcelView.class);
	...
	public InformeSRLiqManoObraMqExcelView() {
		super();
	}
		...
		if (compania != null) {
			try {
				...
				filename = servletContext.getRealPath("") + File.separator + "informes" + File.separator
						+ "mttoSRLiqOperario.xlsx";
				
				data = businessDelegator2View.consultaLiqServRealizadosEquipoOperario(compania,  fechaInicial, fechaFinal, 
				...
				try {
					...
					if (data != null) {
						...
						cell = row.createCell(4	);	cell.setCellValue("CANTIDAD PAGO");	cell.setCellStyle(style2);
						cell = row.createCell(5	);	cell.setCellValue("HORAS");	cell.setCellStyle(style2);
						cell = row.createCell(7	);	cell.setCellValue("TURNO");	cell.setCellStyle(style2);
						cell = row.createCell(6	);	cell.setCellValue("FECHA REGISTRO");	cell.setCellStyle(style2);
						cell = row.createCell(8	);	cell.setCellValue("COD OPERARIO");	cell.setCellStyle(style2);
						cell = row.createCell(9	);	cell.setCellValue("NOM OPERARIO");	cell.setCellStyle(style2);
						cell = row.createCell(10	);	cell.setCellValue("COD CONCEPTO NOMINA");	cell.setCellStyle(style2);
						cell = row.createCell(11	);	cell.setCellValue("NOM CONCEPTO NOMINA");	cell.setCellStyle(style2);
						cell = row.createCell(12	);	cell.setCellValue("BONIFICACION TRABAJADOR");	cell.setCellStyle(style2);
						cell = row.createCell(13	);	cell.setCellValue("VALOR DIA");	cell.setCellStyle(style2);
						cell = row.createCell(14	);	cell.setCellValue("PERIODO LIQUIDACION");	cell.setCellStyle(style2);
						
						cell = row.createCell(15	);	cell.setCellValue("N_REGISTROS");	cell.setCellStyle(style2);
						...
						for (ConsultaServiciosRealizadosMaquinariaDTO ndDTO : data) {
							...
							cell = row.createCell(4	);	cell.setCellValue(ndDTO.getCantidadPago().doubleValue());	cell.setCellStyle(style);
							cell = row.createCell(5	);	cell.setCellValue(ndDTO.getHoras().doubleValue());	cell.setCellStyle(style);
							cell = row.createCell(6	);	cell.setCellValue(ndDTO.getFechaRegistro().toString().substring(0, 10));	cell.setCellStyle(style);
							cell = row.createCell(7	);	cell.setCellValue(ndDTO.getTurno());	cell.setCellStyle(style);
							cell = row.createCell(8	);	cell.setCellValue(ndDTO.getCod_operario());	cell.setCellStyle(style);
							cell = row.createCell(9	);	cell.setCellValue(ndDTO.getNom_operario());	cell.setCellStyle(style);
							cell = row.createCell(10	);	cell.setCellValue(ndDTO.getCod_concepto_nomina());	cell.setCellStyle(style);
							cell = row.createCell(11	);	cell.setCellValue(ndDTO.getNom_concepto_nomina());	cell.setCellStyle(style);
							cell = row.createCell(12	);	cell.setCellValue(ndDTO.getBonificacion_trabajador().doubleValue());	cell.setCellStyle(style);
							cell = row.createCell(13	);	cell.setCellValue(ndDTO.getValorDia().doubleValue());	cell.setCellStyle(style);
							cell = row.createCell(14	);	cell.setCellValue(ndDTO.getPeriodoLiquidacion());	cell.setCellStyle(style);
							
							cell = row.createCell(15	);	cell.setCellValue(1);	cell.setCellStyle(style);
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "mttoSRLiqOperario.xlsx");
	...
	public void impimirirLiqOperarios() {
			...
			try {
				...
				try {
					...
					if (data != null) {
						...
						cell = row.createCell(12	);	cell.setCellValue("BONIFICACION TRABAJADOR");	cell.setCellStyle(style2);
						cell = row.createCell(13	);	cell.setCellValue("VALOR DIA");	cell.setCellStyle(style2);
						cell = row.createCell(14	);	cell.setCellValue("P. INICIAL");	cell.setCellStyle(style2);
						cell = row.createCell(15	);	cell.setCellValue("P. FINAL");	cell.setCellStyle(style2);
						cell = row.createCell(16	);	cell.setCellValue("N_REGISTROS");	cell.setCellStyle(style2);
						...
						for (ConsultaServiciosRealizadosMaquinariaDTO ndDTO : data) {
							...
							cell = row.createCell(14	);	cell.setCellValue(fechaInicial.toString().substring(0, 10));	cell.setCellStyle(style);
							cell = row.createCell(15	);	cell.setCellValue(fechaFinal.toString().substring(0, 10));	cell.setCellStyle(style);
							cell = row.createCell(16	);	cell.setCellValue(1);	cell.setCellStyle(style);
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "MttoSRImprimeLiqOperario.xlsx");
