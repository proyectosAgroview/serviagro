...
@ManagedBean
@ViewScoped
public class InformeAnalisisPlagaView3Mapa implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InformeAnalisisPlagaView3Mapa.class);
	...
	public InformeAnalisisPlagaView3Mapa() {
		super();
...
*/
	...
	private PictureMarkerGraphic buildGisfacesMarker(double latitude, double longitude, String nombrePlanta, String linea,
			String palma, String numeroHojas, String icon) {
	...
	public List<AnalisisPlagaDTO> getData() {
		try {
			...
			if (compania != null && fechaInicial !=null && fechaFinal !=null) {
				...
				data = businessDelegatorView.consultarAnalisisPlaga(compania, fechaInicial, fechaFinal,
	...
	public void setData(List<AnalisisPlagaDTO> data) {
		this.data = data;
	}
