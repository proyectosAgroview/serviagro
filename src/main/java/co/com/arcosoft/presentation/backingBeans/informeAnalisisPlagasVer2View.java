...
@ManagedBean
@ViewScoped
public class informeAnalisisPlagasVer2View implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(informeAnalisisPlagasVer2View.class);
	...
	private List<AnalisisPlagaVer2DTO> data;
	...
	public informeAnalisisPlagasVer2View() {
		super();
	}
	...
	public String exportToPyGExcel() {
		...
		if (compania != null) {
			try {
				List<AnalisisPlagaVer2DTO> data = null;
				...
				data = businessDelegatorView.consultarAnalisisPlagaVer2(compania, fechaInicial, fechaFinal,
						zonasSeleccionadas, flagZona, fincasSeleccionadas, flagFinca, bloquesSeleccionadas, flagBloque,
						lotesSeleccionadas, flagLote, plagasSeleccionadas, flagPlaga);
				...
				try {
					...
					if (data != null) {
						...
						columna1.setCellValue("FECHA REVISIÓN");
						...
						for (AnalisisPlagaVer2DTO costosTotalesDTO : data) {
							...
							cell1.setCellValue(costosTotalesDTO.getFecha());
							cell2.setCellValue(costosTotalesDTO.getMes().doubleValue());
							cell3.setCellValue(costosTotalesDTO.getAnio().doubleValue());
							cell4.setCellValue(costosTotalesDTO.getNombrePlaga());
							cell5.setCellValue(costosTotalesDTO.getCodZona());
							cell6.setCellValue(costosTotalesDTO.getCodFinca());
							cell7.setCellValue(costosTotalesDTO.getNomFinca());
							cell8.setCellValue(costosTotalesDTO.getCodBloque());
							cell9.setCellValue(costosTotalesDTO.getCodLote());
							cell10.setCellValue(costosTotalesDTO.getNumeroHoja().doubleValue());
							cell11.setCellValue(costosTotalesDTO.getNumCenso().doubleValue());

							cell12.setCellValue(costosTotalesDTO.getPromIndividuosHoja().doubleValue());
							cell13.setCellValue(costosTotalesDTO.getDefoliacionProm().doubleValue());
							cell14.setCellValue(costosTotalesDTO.getLongitud());
							cell15.setCellValue(costosTotalesDTO.getLatitud());
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "PLAGAS.xlsx");
	...
	public List<AnalisisPlagaVer2DTO> getData() {
		try {
			if (data == null) {
				data = businessDelegatorView.consultarAnalisisPlagaVer2(null, null, null, null, null, null, null, null,
