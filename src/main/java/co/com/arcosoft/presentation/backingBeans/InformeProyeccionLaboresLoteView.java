...
@ManagedBean
@ViewScoped
public class InformeProyeccionLaboresLoteView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InformeProyeccionLaboresLoteView.class);
	...
	public InformeProyeccionLaboresLoteView() {
		super();
	}
			...
			if (compania != null && fechaInicial != null && fechaFinal != null) {
				...
				if (data != null && data.size() > 0) {
					try {
						...
						for (ProyeccionLaboresLoteDTO pLabores : data) {
							eventModel.addEvent(new DefaultScheduleEvent(pLabores.getDescripcion(),
									pLabores.getFechaInicial(), pLabores.getFechaFinal()));
