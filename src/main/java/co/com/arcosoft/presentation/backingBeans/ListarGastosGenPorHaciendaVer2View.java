...
@ManagedBean
@ViewScoped
public class ListarGastosGenPorHaciendaVer2View implements Serializable {
	private static final long serialVersionUID = 1L;
	@SuppressWarnings("unused")
	private static final Logger log = LoggerFactory.getLogger(ListarGastosGenPorHaciendaVer2View.class);
	...
	public ListarGastosGenPorHaciendaVer2View() {
		super();
	}
		...
		try {
			...
			if (compania != null && fechaInicial != null && fechaFinal != null) {
				...
				dataDetalle = businessDelegatorView.consultarCostosIndirectos(compania, fechaInicial, fechaFinal,
					"0", 1L, "0", 1L, haciendasSeleccionadas, flagHacienda, "0", 1L, "0", 1L);
			}
