...
@ManagedBean
@ViewScoped
public class InformeSRPyGMaquinariaConceptoGastoView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InformeSRPyGMaquinariaConceptoGastoView.class);
	...
	private InputNumber txtUtilidadArea;
	
	
	public InformeSRPyGMaquinariaConceptoGastoView() {
		super();
	}
	...
	public void consultaPyGMaquianria() {
		try {
			...
			if(compania != null && fechaInicial != null && fechaFinal != null){
				...
				data = businessDelegator2View.pr_pyg_equipo_conceptogasto(compania,  fechaInicial, fechaFinal, 
	...
	//		txtCombustible.setValue(combustible);
		...
		//	}
			...
			// txtGlnArea.setValue(Math.round((combustible/cantidad) * 100.0) / 100.0);
			 ...
			 txtUtilidadArea.setValue(Math.round((utilidad/cantidad) * 100.0) / 100.0);
			}
	...
	public InputNumber getTxtUtilidadArea() {
		return txtUtilidadArea;
	}

	public void setTxtUtilidadArea(InputNumber txtUtilidadArea) {
		this.txtUtilidadArea = txtUtilidadArea;
	}
