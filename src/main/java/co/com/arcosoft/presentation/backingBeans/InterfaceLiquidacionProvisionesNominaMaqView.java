...
@ManagedBean
@ViewScoped
public class InterfaceLiquidacionProvisionesNominaMaqView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InterfaceLiquidacionProvisionesNominaMaqView.class);
	...
	public InterfaceLiquidacionProvisionesNominaMaqView() {
		super();
	}
	...
	public Long calculoProvisiones() {
		try {
			// Long compania = 1L;
		...
		//	SimpleDateFormat anio = new SimpleDateFormat("yyyy");
			...
			if (compania != null && fechaInicial !=null && fechaFinal !=null) {
			    ...
			    if(diffDays == 13 || diffDays == 14 || diffDays == 15 ||diffDays == 16) {
					businessDelegator2View.borrar_dat_proviciones_cierre_nomina_mq(compania, fechaInicial, fechaFinal);
					 
					businessDelegator2View.pr_calculo_provisiones_maq
							(compania, fechaInicial, fechaFinal,"0",1L, "0", usuario); 
	
					FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, 
							"La interfaz de liquidación de provisiones fue ejecutada con éxito. ",
							""));
					
					disableButton="true";
			    }else{
			    	FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, 
							"El período seleccionado debe comprender 14, 15 ó 16 días (El rango debe ser equivalente a una quincena del año). ",
							""));
	...
	public void borrarProvisionesTrabajador() {
		try {
			// Long compania = 1L;
			Long compania = new Long(getCompaniaIdSession());
			Long usuario = new Long(getUsuarioIdSession());
		...
		//	SimpleDateFormat anio = new SimpleDateFormat("yyyy");
			...
			if (compania != null && fechaInicial !=null && fechaFinal !=null && trabajadorSeleccionadas!=null) {
				
				
			    	businessDelegator2View.pr_borrar_trabajador_provisiones(  compania,   fechaInicial,   fechaFinal,  trabajadorSeleccionadas)  ;
			    	FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, 
							"Las provisiones de los trabajadores seleccionados fueron borradas con éxito. ",
							""));
