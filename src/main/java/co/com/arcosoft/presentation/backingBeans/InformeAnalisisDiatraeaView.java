...
@ManagedBean
@ViewScoped
public class InformeAnalisisDiatraeaView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InformeAnalisisDiatraeaView.class);
	...
	private List<AnalisisDiatraeaDTO> data;
	...
	public InformeAnalisisDiatraeaView() {
		super();
	}
	...
	public List<AnalisisDiatraeaDTO> getData() {
		try {
			// Long compania = 1L;
			...
			if (compania != null) {
				...
				data = businessDelegatorView.consultarAnalisisDiatraea(compania, fechaInicial, fechaFinal,
						zonasSeleccionadas, flagZona, fincasSeleccionadas, flagFinca, bloquesSeleccionadas, flagBloque,
						lotesSeleccionadas, flagLote);
