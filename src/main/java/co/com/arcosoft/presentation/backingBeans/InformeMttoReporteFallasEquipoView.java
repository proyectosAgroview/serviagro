...
@ManagedBean
@ViewScoped
public class InformeMttoReporteFallasEquipoView  implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InformeMttoReporteFallasEquipoView .class);
	...
	private List<MttoReporteFallasEquipoDTO> data;
	...
	public InformeMttoReporteFallasEquipoView () {
		super();
	}
	...
	public String exportToPyGExcel() {
		...
		if (compania != null) {
			try {
				...
				List<MttoReporteFallasEquipoDTO> data = null;
				...
				filename = servletContext.getRealPath("") + File.separator + "informes" + File.separator
						+ "MttoReporteFallasEquipos.xlsx";

				data = businessDelegatorView.consultarInformeReporteFallasEquipo(compania, fechaInicial, fechaFinal, propietariosSeleccionadas, flagPropietario, equiposSeleccionadas, flagEquipo);
				...
				try {
					...
					if (data != null) {
						...
						cell = row.createCell(	7	);	cell.setCellValue("motivo_entrda_taller"); cell.setCellStyle(style2);
						cell = row.createCell(	8	);	cell.setCellValue("agente_causador"); cell.setCellStyle(style2);
						cell = row.createCell(	9	);	cell.setCellValue("cod_operario_maquina"); cell.setCellStyle(style2);
						cell = row.createCell(	10	);	cell.setCellValue("nom_operario_maquina"); cell.setCellStyle(style2);
						cell = row.createCell(	11	);	cell.setCellValue("cod_supervisor_mtto"); cell.setCellStyle(style2);
						cell = row.createCell(	12	);	cell.setCellValue("nom_supervisor_mtto"); cell.setCellStyle(style2);
						cell = row.createCell(	13	);	cell.setCellValue("descripcion_falla"); cell.setCellStyle(style2);
						cell = row.createCell(	14	);	cell.setCellValue("hora_inicial_parada"); cell.setCellStyle(style2);
						cell = row.createCell(	15	);	cell.setCellValue("hora_final_parada"); cell.setCellStyle(style2);
						cell = row.createCell(	16	);	cell.setCellValue("duracion_real_hh"); cell.setCellStyle(style2);
						cell = row.createCell(	17	);	cell.setCellValue("dat_reporte_fallas_id"); cell.setCellStyle(style2);
						cell = row.createCell(	18	);	cell.setCellValue("codtag"); cell.setCellStyle(style2);
						cell = row.createCell(	19	);	cell.setCellValue("nombretag"); cell.setCellStyle(style2);
						cell = row.createCell(	20	);	cell.setCellValue("anio"); cell.setCellStyle(style2);
						cell = row.createCell(	21	);	cell.setCellValue("mes_corto"); cell.setCellStyle(style2);
						
						int pos_i = 8;

						for (MttoReporteFallasEquipoDTO ndDTO : data) {
							...
							cell.setCellValue(ndDTO.getCod_operario_maquina());
							cell = row.createCell(10);
							cell.setCellValue(ndDTO.getNom_operario_maquina());
							cell = row.createCell(11);
							cell.setCellValue(ndDTO.getCod_supervisor_mtto());
							cell = row.createCell(12);
							cell.setCellValue(ndDTO.getNom_supervisor_mtto());
							cell = row.createCell(13);
							cell.setCellValue(ndDTO.getDescripcion_falla());
							cell = row.createCell(14);
							cell.setCellValue(ndDTO.getHora_inicial_parada());
							cell = row.createCell(15);
							cell.setCellValue(ndDTO.getHora_final_parada());
							cell = row.createCell(16);
							cell.setCellValue(ndDTO.getDuracion_real_hh().doubleValue());
							cell = row.createCell(17);
							cell.setCellValue(ndDTO.getDat_reporte_fallas_id().intValue());
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "MttoReporteFallasEquipos.xlsx");
	...
	public List<MttoReporteFallasEquipoDTO> getData() {
		try {
			if (data == null) {
				data = businessDelegatorView.consultarInformeReporteFallasEquipo(null, null, null, null, null, null, null);
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
