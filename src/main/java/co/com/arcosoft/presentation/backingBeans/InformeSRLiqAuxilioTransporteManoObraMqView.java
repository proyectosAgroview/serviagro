...
@ManagedBean
@ViewScoped
public class InformeSRLiqAuxilioTransporteManoObraMqView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InformeSRLiqAuxilioTransporteManoObraMqView.class);
	...
	public InformeSRLiqAuxilioTransporteManoObraMqView() {
		super();
	}
	...
	public void liqAuxilioTransporteOperarios() {
		...
		if (compania != null) {
			try {
				...
				filename = servletContext.getRealPath("") + File.separator + "informes" + File.separator
						+ "mttoSRLiqAuxTransporteOperario.xlsx";
				
				data = businessDelegator2View.pr_liq_aux_transporte_operario(compania,  fechaInicial, fechaFinal, 
				...
				try {
					...
					if (data != null) {
						...
						cell = row.createCell(4	);	cell.setCellValue("VR. AUX TRANSPORTE");	cell.setCellStyle(style2);
						cell = row.createCell(5	);	cell.setCellValue("TURNO");	cell.setCellStyle(style2);
						cell = row.createCell(6	);	cell.setCellValue("FECHA REGISTRO");	cell.setCellStyle(style2);
						cell = row.createCell(7	);	cell.setCellValue("COD OPERARIO");	cell.setCellStyle(style2);
						cell = row.createCell(8	);	cell.setCellValue("NOM OPERARIO");	cell.setCellStyle(style2);
						cell = row.createCell(9	);	cell.setCellValue("COD CONCEPTO NOMINA");	cell.setCellStyle(style2);
						cell = row.createCell(10	);	cell.setCellValue("NOM CONCEPTO NOMINA");	cell.setCellStyle(style2);
						cell = row.createCell(11	);	cell.setCellValue("PERIODO LIQUIDACION");	cell.setCellStyle(style2);
						
						cell = row.createCell(12	);	cell.setCellValue("N_REGISTROS");	cell.setCellStyle(style2);
						...
						for (ConsultaServiciosRealizadosMaquinariaDTO ndDTO : data) {
							...
							cell = row.createCell(4	);	cell.setCellValue(ndDTO.getAuxilio_transporte().doubleValue());	cell.setCellStyle(style);
							cell = row.createCell(5	);	cell.setCellValue(ndDTO.getTurno());	cell.setCellStyle(style);
							cell = row.createCell(6	);	cell.setCellValue(ndDTO.getFechaRegistro().toString().substring(0, 10));	cell.setCellStyle(style);
							cell = row.createCell(7	);	cell.setCellValue(ndDTO.getCod_operario());	cell.setCellStyle(style);
							cell = row.createCell(8	);	cell.setCellValue(ndDTO.getNom_operario());	cell.setCellStyle(style);
							cell = row.createCell(9	);	cell.setCellValue(ndDTO.getCod_concepto_nomina());	cell.setCellStyle(style);
							cell = row.createCell(10	);	cell.setCellValue(ndDTO.getNom_concepto_nomina());	cell.setCellStyle(style);
							cell = row.createCell(11	);	cell.setCellValue(ndDTO.getPeriodoLiquidacion());	cell.setCellStyle(style);
							
							cell = row.createCell(12	);	cell.setCellValue(1);	cell.setCellStyle(style);
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "mttoSRLiqAuxTransporteOperario.xlsx");
