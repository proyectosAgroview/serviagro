...
@ManagedBean
@ViewScoped
public class InformeSRConsultaPinesPorMaquinaView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InformeSRConsultaPinesPorMaquinaView.class);
	...
	public InformeSRConsultaPinesPorMaquinaView() {
		super();
	}
	...
	public void consultaPinesPorMaquina() {
		try {
			...
			data = businessDelegator2View.pr_numero_pines_por_maquina( compania,   fechaInicial,
					 fechaFinal, equiposSeleccionadas,  flagEquipo) ;
			
		       
		        for( ConsultaServiciosRealizadosMaquinariaDTO data1 : data) {
		        	
		        	cantidad += data1.getNpines_maquina().doubleValue();
