...
@ManagedBean
@ViewScoped
public class InterfaceManagerExportRegMoView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InterfaceManagerExportRegMoView.class);
	...
	String filename = "C://ARCOSOFT/ERP/EXP_DEVENGOS"+dateText+".TXT";
	...
	public InterfaceManagerExportRegMoView() {
		super();
	}
	...
	public String action_informe1() {
		...
		if (data != null && data.size() > 0) {
			...
			FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "",
					"No existen datos para generar la interface INT_EXP_NOVEDADES_MO_MANAGER"));
	...
	public List<interfaceManagerExpRegistrosMODTO> getData() {
		try {
			...
			if (compania != null && fechaInicial !=null && fechaFinal !=null) {
				...
				data = businessDelegatorView.consultaInterfaceManagerExportarMo(compania, fechaInicial,
						fechaFinal,contratistasSeleccionadas,
						flagContratista, trabajadorSeleccionadas,
		...
		if (compania != null) {
			try {
				...
				filename = servletContext.getRealPath("") + File.separator + "informes" + File.separator
						+ "interfaceManagerDevengosMo.xlsx";

				data = businessDelegatorView.consultaInterfaceManagerExportarMo(compania, fechaInicial, fechaFinal,
				...
				try {
					...
					if (data != null) {
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "interfaceManagerDevengosMo.xlsx");
			...
			try {
				...
				try {
					...
					if (data != null) {
						...
						file1 = new DefaultStreamedContent(stream, "application/xlsx", "interfaceManagerDevengosMo.xlsx");
