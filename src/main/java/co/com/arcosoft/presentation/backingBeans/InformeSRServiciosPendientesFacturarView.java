...
@ManagedBean
@ViewScoped
public class InformeSRServiciosPendientesFacturarView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InformeSRServiciosPendientesFacturarView.class);
	...
	public InformeSRServiciosPendientesFacturarView() {
		super();
	}
	...
	public void serviciosPendientesPorFacturar() throws NumberFormatException, Exception {
		...
		if (compania != null) {
			try {
				...
				filename = servletContext.getRealPath("") + File.separator + "informes" + File.separator
						+ "MttoSRMaqPendientesFacturar.xlsx";

				data = businessDelegator2View.consultaServRealizadosEquipoDetPendientesFact(compania, estadoServicio, fechaInicial, fechaFinal, 
				...
				try {
					...
					if (data != null) {
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "MttoSRMaqPendientesFacturar.xlsx");
