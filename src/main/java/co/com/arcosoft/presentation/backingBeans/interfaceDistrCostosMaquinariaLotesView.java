...
@ManagedBean
@ViewScoped
public class interfaceDistrCostosMaquinariaLotesView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(interfaceDistrCostosMaquinariaLotesView.class);
	...
	public interfaceDistrCostosMaquinariaLotesView() {
		super();
	}
	...
	public Long cierreCostosMaquinariaLote() {
		try {
			// Long compania = 1L;
		...
		//	SimpleDateFormat anio = new SimpleDateFormat("yyyy");
			...
			Long borrarCMaquinaria = null;
			Long insertMaquinariaLotes = null;
		...
		//	fechaFinal = (FacesUtils.checkDate(txtFechaFinal));
			...
			if (compania != null && anio !=null && mes !=null) {
				...
				borrarCMaquinaria  = businessDelegatorView.borrarCierreCostosDistriMqAgricola( compania,  anio,  mes);
				 
				insertMaquinariaLotes = businessDelegatorView.cierreCostosDistriMqAgricola(compania, anio, mes,  "0", 1L,  "0", 1L); 
			...
			FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, 
					"Válida que existan registros de horas máquina en el periodo seleccionado ",
					""));
	...
	public Long recalculoHorasMaquina() {
		try {
			// Long compania = 1L;
		...
		//	SimpleDateFormat anio = new SimpleDateFormat("yyyy");
			...
			if (compania != null && anio !=null && mes !=null) {
				...
				Long recalculoMaquinaria  = businessDelegator2View.pr_recalculo_vr_hora_maquina( compania,  fechaInicial,  fechaFinal);
				 
			
				FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, 
						"La interfaz de recálculo de horas máquina  fue ejecutada con éxito. ",
						""));
			...
			FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, 
					"La interfaz esta fallando, válidar que existan apuntes de máquinaria para el periodo seleccionado ",
					""));
