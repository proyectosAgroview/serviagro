...
@ManagedBean
@ViewScoped
public class ListarGastosGenPorHaciendaView implements Serializable {
	private static final long serialVersionUID = 1L;
	@SuppressWarnings("unused")
	private static final Logger log = LoggerFactory.getLogger(ListarGastosGenPorHaciendaView.class);
	...
	public ListarGastosGenPorHaciendaView() {
		super();
	}
