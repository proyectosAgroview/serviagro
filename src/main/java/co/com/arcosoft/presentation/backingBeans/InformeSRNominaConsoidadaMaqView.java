...
@ManagedBean
@ViewScoped
public class InformeSRNominaConsoidadaMaqView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InformeSRNominaConsoidadaMaqView.class);
	...
	public InformeSRNominaConsoidadaMaqView() {
		super();
	}
	...
	public void imprimirNominaConsolidaMaq() throws NumberFormatException, Exception {
		...
		if (compania != null && fechaInicial != null && fechaInicial !=null) {
			try {
				...
				filename = servletContext.getRealPath("") + File.separator + "informes" + File.separator
						+ "MttoSRNominaConsolidadaMaq.xlsx";
				
				data = businessDelegator2View.pr_comprobante_pago_nomina(compania,  fechaInicial, fechaFinal, 
				...
				try {
					...
					if (data != null) {
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "MttoSRNominaConsolidadaMaq.xlsx");
	...
	public void comprobantesPagoMaq() {
