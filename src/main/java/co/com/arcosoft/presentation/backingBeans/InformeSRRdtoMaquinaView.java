...
@ManagedBean
@ViewScoped
public class InformeSRRdtoMaquinaView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InformeSRRdtoMaquinaView.class);
	...
	public InformeSRRdtoMaquinaView() {
		super();
	}
	...
	public void consultaRdtoMaquinaria() {
		try {
