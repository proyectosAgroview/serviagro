...
@ManagedBean
@ViewScoped
public class InterfaceLiquidacionNominaOperariosMqView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InterfaceLiquidacionNominaOperariosMqView.class);
	...
	public InterfaceLiquidacionNominaOperariosMqView() {
		super();
	}
		...
		//	fechaFinal = (FacesUtils.checkDate(txtFechaFinal));		
			...
			if (compania != null && fechaInicial !=null && fechaFinal !=null) {
			    ...
			    if(diffDays == 13 || diffDays == 14 || diffDays == 15 ||diffDays == 16) {
					borrarNomina  = businessDelegator2View.borrarLiqServRealizadosOperario(compania, fechaInicial, fechaFinal);
					 
					insertNomina = businessDelegator2View.interfazLiqServRealizadosEquipoOperario
					...
					FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, 
							"La interfaz de liquidación de operarios fue ejecutada con éxito. ",
							""));
