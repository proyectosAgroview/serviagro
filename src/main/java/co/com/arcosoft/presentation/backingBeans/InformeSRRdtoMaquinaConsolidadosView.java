...
@ManagedBean
@ViewScoped
public class InformeSRRdtoMaquinaConsolidadosView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InformeSRRdtoMaquinaConsolidadosView.class);
	...
	public InformeSRRdtoMaquinaConsolidadosView() {
		super();
	}
	...
	public void consultaRdtoMaquianriaConsolidados() {
		try {
