...
@ManagedBean
@ViewScoped
public class InformeSRLaboresPorOperarioView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InformeSRLaboresPorOperarioView.class);
	...
	public InformeSRLaboresPorOperarioView() {
		super();
	}
	...
	public void laboresRealizadasPorOperarios() throws NumberFormatException, Exception {
		...
		String estadoServicio = "Todos";//FacesUtils.checkString(txtEstadoServicio);
		...
		if (compania != null) {
			try {
				...
				filename = servletContext.getRealPath("") + File.separator + "informes" + File.separator
						+ "MttoSRMLaboresOperario.xlsx";

				data = businessDelegator2View.consultaServRealizadosEquipoDet(compania, estadoServicio, fechaInicial, fechaFinal, 
						...
						flagUnidadMedida, grupoLaboresSeleccionadas, flagGrupoLabor, equiposSeleccionadas, flagEquipo, 0L,0L,0L);
				...
				try {
					...
					if (data != null) {
						...
						cell = row.createCell(44	);	cell.setCellValue("VR. UNITARIO OPERARIO");	cell.setCellStyle(style2);
						cell = row.createCell(45	);	cell.setCellValue("VR. TOTAL OPERARIO");	cell.setCellStyle(style2);
						cell = row.createCell(46	);	cell.setCellValue("CONSECUTIVO RDL");	cell.setCellStyle(style2);
						...
						for (ConsultaServiciosRealizadosMaquinariaDTO ndDTO : data) {
							...
							cell = row.createCell(44	);	cell.setCellValue(ndDTO.getValor_unitario_trabajador().doubleValue());	cell.setCellStyle(style);
							cell = row.createCell(45	);	cell.setCellValue(ndDTO.getValor_total_trabajador().doubleValue());	cell.setCellStyle(style);
							cell = row.createCell(46	);	cell.setCellValue(ndDTO.getConsecutivoRdl().longValue());	cell.setCellStyle(style);
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "MttoSRMLaboresOperario.xlsx");
