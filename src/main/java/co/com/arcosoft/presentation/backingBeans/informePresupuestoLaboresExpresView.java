...
@ManagedBean
@ViewScoped
public class informePresupuestoLaboresExpresView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(informePresupuestoLaboresExpresView.class);
	...
	public informePresupuestoLaboresExpresView() {
		super();
	}
		...
		if (compania != null) {
			try {
				...
				filename = servletContext.getRealPath("") + File.separator + "informes" + File.separator
						+ "PresupuestoExpres.xlsx";

				data = businessDelegatorView.consultarInformeProyeccionLaboresLoteExpress(compania, fechaInicial,
				...
				try {
					...
					if (data != null) {
						...
						columna17.setCellValue("AÑO-MES");
						...
						columna20.setCellValue("DURACIÓN");
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "PresupuestoExpres.xlsx");
