...
@ManagedBean
@ViewScoped
public class InformeProntuarioLotesView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InformeProntuarioLotesView.class);
	...
	public InformeProntuarioLotesView() {
		super();
	}
	...
	private void createbarModel1() throws NumberFormatException, Exception {
		...
		if (compania != null) {
			List<ProntuarioLotesDTO> data;
			try {

				data = businessDelegatorView.consultarInformeProntuarioLotes(compania, zonasSeleccionadas, flagZona,
				...
				for (ProntuarioLotesDTO prontuarioLotesDTO : data) {
					// barModel1.set(distribucionAreaVariedadDTO.getVariedad(),
					// distribucionAreaVariedadDTO.getArea());
					series.set(prontuarioLotesDTO.getLoteA(), prontuarioLotesDTO.getArea());
	...
	public String exportToPyGExcel() throws NumberFormatException, Exception {
		...
		if (compania != null) {
			try {
				...
				List<ProntuarioLotesDTO> data = null;
				...
				filename = servletContext.getRealPath("") + File.separator + "informes" + File.separator
						+ "ProntuarioLotes.xlsx";

				data = businessDelegatorView.consultarInformeProntuarioLotes(compania, zonasSeleccionadas, flagZona,
						idHacienda, flagFinca, bloquesSeleccionadas, flagBloque, idLote, flagLote,
						tenenciasSeleccionadas, flagTenencia);
				...
				try {
					...
					if (data != null) {
						...
						for (ProntuarioLotesDTO ndDTO : data) {
							...
							cell1.setCellValue(ndDTO.getNomFinca());
							cell1.setCellStyle(style1);
							cell2.setCellValue(ndDTO.getLoteA());
							cell2.setCellStyle(style);

							cell3.setCellValue(ndDTO.getNomLote());
							cell2.setCellStyle(style);

							cell4.setCellValue(ndDTO.getFechaSiembra().substring(0, 10));
							cell4.setCellStyle(style);

							cell5.setCellValue(ndDTO.getFechaUltCorte().substring(0, 10));
							cell5.setCellStyle(style);

							cell6.setCellValue(ndDTO.getArea().doubleValue());
							cell6.setCellStyle(style);

							cell7.setCellValue(ndDTO.getNumPlantasActuales().doubleValue());
							cell7.setCellStyle(style);

							cell8.setCellValue(ndDTO.getEdadHoy());
							cell8.setCellStyle(style);

							cell9.setCellValue(ndDTO.getVariedad());
							cell9.setCellStyle(style);
							cell10.setCellValue(ndDTO.getnCortes().intValue());
							cell10.setCellStyle(style);
							cell11.setCellValue(ndDTO.getDistSiembra().doubleValue());
							cell11.setCellStyle(style);
							cell12.setCellValue(ndDTO.getNomTenencia());
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "ProntuarioLotes.xlsx");
