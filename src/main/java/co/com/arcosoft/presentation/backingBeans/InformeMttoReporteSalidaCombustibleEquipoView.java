...
@ManagedBean
@ViewScoped
public class InformeMttoReporteSalidaCombustibleEquipoView  implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InformeMttoReporteSalidaCombustibleEquipoView .class);
	...
	private List<MttoSalidaCombustibleEquipoDTO> data;
	...
	public InformeMttoReporteSalidaCombustibleEquipoView () {
		super();
	}
	...
	public String exportToPyGExcel() {
		...
		if (compania != null) {
			try {
				...
				List<MttoSalidaCombustibleEquipoDTO> data = null;
				...
				filename = servletContext.getRealPath("") + File.separator + "informes" + File.separator
						+ "MttoReporteSalidaCombustible.xlsx";

				data = businessDelegatorView.consultarInformeSalidasCombustibleEquipo(compania, fechaInicial, fechaFinal, propietariosSeleccionadas, flagPropietario, equiposSeleccionadas, flagEquipo);
				...
				try {
					...
					if (data != null) {
						...
						cell = row.createCell(	2	);	cell.setCellValue("numero_planilla_fisica");
						cell = row.createCell(	3	);	cell.setCellValue("cod_equipo");
						cell = row.createCell(	4	);	cell.setCellValue("Nom_equipo");
						cell = row.createCell(	5	);	cell.setCellValue("nom_medidor");
						cell = row.createCell(	6	);	cell.setCellValue("horometro_entrada");
						cell = row.createCell(	7	);	cell.setCellValue("odomentro_entrada");
						cell = row.createCell(	8	);	cell.setCellValue("nom_tipo_abastecimiento");
						cell = row.createCell(	9	);	cell.setCellValue("nom_bomba_abastecimiento");
						cell = row.createCell(	10	);	cell.setCellValue("cod_almacen");
						cell = row.createCell(	11	);	cell.setCellValue("cod_despachador");
						cell = row.createCell(	12	);	cell.setCellValue("cod_conductor");
						cell = row.createCell(	13	);	cell.setCellValue("nom_despachador");
						cell = row.createCell(	14	);	cell.setCellValue("cod_producto");
						cell = row.createCell(	15	);	cell.setCellValue("nom_producto");
						cell = row.createCell(	16	);	cell.setCellValue("cod_um_producto");
						cell = row.createCell(	17	);	cell.setCellValue("nom_um_producto");
						cell = row.createCell(	18	);	cell.setCellValue("cantidad");
						cell = row.createCell(	19	);	cell.setCellValue("valor_unitario");
						cell = row.createCell(	20	);	cell.setCellValue("costo_total");
						cell = row.createCell(	21	);	cell.setCellValue("observacion");
						cell = row.createCell(	22	);	cell.setCellValue("dat_abast_combustible_id");
						cell = row.createCell(	23	);	cell.setCellValue("año");
						cell = row.createCell(	24	);	cell.setCellValue("mes");
						int pos_i = 1;

						for (MttoSalidaCombustibleEquipoDTO ndDTO : data) {
							...
							cell.setCellValue(ndDTO.getNumero_planilla_fisica().intValue());
							...
							cell.setCellValue(ndDTO.getNom_tipo_abastecimiento());
							cell = row.createCell(7);
							cell.setCellValue(ndDTO.getNom_bomba_abastecimiento());
							cell = row.createCell(8);
							cell.setCellValue(ndDTO.getCod_almacen());
							cell = row.createCell(9);
							cell.setCellValue(ndDTO.getNom_almacen());
							cell = row.createCell(10);
							cell.setCellValue(ndDTO.getCod_despachador());
							cell = row.createCell(11);
							cell.setCellValue(ndDTO.getNom_despachador());
							cell = row.createCell(12);
							cell.setCellValue(ndDTO.getCod_conductor());
							cell = row.createCell(13);
							cell.setCellValue(ndDTO.getNom_conductor());
							cell = row.createCell(14);
							cell.setCellValue(ndDTO.getCod_producto());
							cell = row.createCell(15);
							cell.setCellValue(ndDTO.getNom_producto());
							
							cell = row.createCell(16);
							cell.setCellValue(ndDTO.getCod_um_producto());
							
							cell = row.createCell(17);
							cell.setCellValue(ndDTO.getNom_um_producto());
							...
							cell.setCellValue(ndDTO.getDat_abast_combustible_id().intValue());
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "MttoReporteSalidaCombustible.xlsx");
	...
	public List<MttoSalidaCombustibleEquipoDTO> getData() {
		try {
			if (data == null) {
				data = businessDelegatorView.consultarInformeSalidasCombustibleEquipo(null, null, null, null, null, null, null);
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
