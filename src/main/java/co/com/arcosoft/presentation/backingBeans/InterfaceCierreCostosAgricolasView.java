...
@ManagedBean
@ViewScoped
public class InterfaceCierreCostosAgricolasView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InterfaceCierreCostosAgricolasView.class);
	...
	public InterfaceCierreCostosAgricolasView() {
		super();
	}
	...
	public Long cierreCostosAgricolas() {
		try {
			// Long compania = 1L;
			...
			if (compania != null && fechaInicial !=null && fechaFinal !=null) {
			    ...
			    if(diffDays == 7) {
			    	...
			    	FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, 
							"El período seleccionado debe comprender 7 días (El rango debe ser equivalente a una semana del año). ",
							""));
