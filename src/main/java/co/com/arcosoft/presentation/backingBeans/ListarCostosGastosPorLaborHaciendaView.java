...
@ManagedBean
@ViewScoped
public class ListarCostosGastosPorLaborHaciendaView implements Serializable {
	private static final long serialVersionUID = 1L;
	@SuppressWarnings("unused")
	private static final Logger log = LoggerFactory.getLogger(ListarCostosGastosPorLaborHaciendaView.class);
	...
	public ListarCostosGastosPorLaborHaciendaView() {
		super();
	}
			...
			if (compania != null) {
				try {
					...
					filename = servletContext.getRealPath("") + File.separator + "informes" + File.separator
							+ "CostosGastosPorLaborHacienda.xlsx";
					...
					try {
						...
						if (data != null) {
							...
							file = new DefaultStreamedContent(stream, "application/xlsx", "CostosGastosPorLaborHacienda.xlsx");
