...
@ManagedBean
@ViewScoped
public class InformeSRIngresosMaqView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InformeSRIngresosMaqView.class);
	...
	public InformeSRIngresosMaqView() {
		super();
	}
	...
	public void consultaIngresosMaq() {
		try {
