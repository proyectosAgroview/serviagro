...
@ManagedBean
@ViewScoped
public class ListarLaboresPorHaciendaView implements Serializable {
	private static final long serialVersionUID = 1L;
	@SuppressWarnings("unused")
	private static final Logger log = LoggerFactory.getLogger(ListarLaboresPorHaciendaView.class);
	...
	public ListarLaboresPorHaciendaView() {
		super();
	}
