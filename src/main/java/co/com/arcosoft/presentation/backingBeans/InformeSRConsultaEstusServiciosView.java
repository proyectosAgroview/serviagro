...
@ManagedBean
@ViewScoped
public class InformeSRConsultaEstusServiciosView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InformeSRConsultaEstusServiciosView.class);
	...
	public InformeSRConsultaEstusServiciosView() {
		super();
	}
	...
	public void serviciosEstatus() throws NumberFormatException, Exception {
		...
		if (compania != null) {
			try {
				...
				filename = servletContext.getRealPath("") + File.separator + "informes" + File.separator
						+ "MttoSRMaqConsultaEstatusServicios.xlsx";

				data = businessDelegator2View.pr_consulta_servrea_estus(compania,  fechaInicial, fechaFinal, 
						clientesSeleccionadas, flagClientes, nivel2ClientesmqSeleccionadas, flagNivel2Clientesmq,
						laboresSeleccionadas, flagLabor, equiposSeleccionadas, flagEquipo);
				...
				try {
					...
					if (data != null) {
						...
						cell = row.createCell(7	);	cell.setCellValue("COD. LABOR");	cell.setCellStyle(style2);
						cell = row.createCell(8	);	cell.setCellValue("NOM LABOR");	cell.setCellStyle(style2);	
						cell = row.createCell(9	);	cell.setCellValue("CANTIDAD PAGO");	cell.setCellStyle(style2);	
						cell = row.createCell(10);	cell.setCellValue("COD UDAD MED PAGO");	cell.setCellStyle(style2);	
						cell = row.createCell(11);	cell.setCellValue("FECHA REGISTRO");	cell.setCellStyle(style2);	
						cell = row.createCell(12);	cell.setCellValue("HOROMETRO INICIAL");	cell.setCellStyle(style2);	
						cell = row.createCell(13);	cell.setCellValue("HOROMETRO FINAL");	cell.setCellStyle(style2);	
						cell = row.createCell(14);	cell.setCellValue("VALOR UNITARIO");	cell.setCellStyle(style2);	
						cell = row.createCell(15);	cell.setCellValue("INGRESO TOTAL");	cell.setCellStyle(style2);	
						cell = row.createCell(16);	cell.setCellValue("COD CLIENTE");	cell.setCellStyle(style2);	
						cell = row.createCell(17);	cell.setCellValue("NOM CLIENTE");	cell.setCellStyle(style2);	
						cell = row.createCell(18);	cell.setCellValue("TURNO");	cell.setCellStyle(style2);	
						cell = row.createCell(19);	cell.setCellValue("NOM OPERARIO");	cell.setCellStyle(style2);	
						cell = row.createCell(20);	cell.setCellValue("COD IMPLEMENTO");	cell.setCellStyle(style2);	
						cell = row.createCell(21);	cell.setCellValue("P. INICIAL");	cell.setCellStyle(style2);	
						cell = row.createCell(22);	cell.setCellValue("P. FINAL");	cell.setCellStyle(style2);
						cell = row.createCell(23);	cell.setCellValue("DOC. FACTURA");	cell.setCellStyle(style2);
						cell = row.createCell(24);	cell.setCellValue("PIN");	cell.setCellStyle(style2);
						cell = row.createCell(25);	cell.setCellValue("ID REGISTRO");	cell.setCellStyle(style2);
						cell = row.createCell(26);	cell.setCellValue("ESTATUS REGISTRO");	cell.setCellStyle(style2);
						cell = row.createCell(27);	cell.setCellValue("PREFACTURA");	cell.setCellStyle(style2);
						cell = row.createCell(28);	cell.setCellValue("CONSECUTIVO RDL");	cell.setCellStyle(style2);
						...
						for (ConsultaServiciosRealizadosMaquinariaDTO ndDTO : data) {
							...
							cell = row.createCell(7	);	cell.setCellValue(ndDTO.getCodLabor());
							cell = row.createCell(8	);	cell.setCellValue(ndDTO.getNomLabor());	
							cell = row.createCell(9	);	cell.setCellValue(ndDTO.getCantidadPago().doubleValue());	
							cell = row.createCell(10	);	cell.setCellValue(ndDTO.getCodUdadMed());	
							...
							cell = row.createCell(12	);	cell.setCellValue(ndDTO.getHorometroInicial().doubleValue());	
							cell = row.createCell(13	);	cell.setCellValue(ndDTO.getHorometroFinal().doubleValue());	
						
							cell = row.createCell(14	);	cell.setCellValue(ndDTO.getValorUnitario().doubleValue());	
							cell = row.createCell(15	);	cell.setCellValue(ndDTO.getCostoTotal().doubleValue());	
							cell = row.createCell(16	);	cell.setCellValue(ndDTO.getCodCliente());	
							cell = row.createCell(17	);	cell.setCellValue(ndDTO.getNomCliente());	
							cell = row.createCell(18	);	cell.setCellValue(ndDTO.getTurno());	
							cell = row.createCell(19	);	cell.setCellValue(ndDTO.getNom_operario());	
							cell = row.createCell(20	);	cell.setCellValue(ndDTO.getCod_implemento());	
							...
							cell = row.createCell(23	);	cell.setCellValue(ndDTO.getDocFactura());	
							cell = row.createCell(24	);	cell.setCellValue(ndDTO.getPin().doubleValue());	
							cell = row.createCell(25	);	cell.setCellValue(ndDTO.getIdRegistro().doubleValue());	
							cell = row.createCell(26	);	cell.setCellValue(ndDTO.getEstatusRegistro());	
							cell = row.createCell(27	);	cell.setCellValue(ndDTO.getConsecutivoPrefactura().doubleValue());	
							cell = row.createCell(28);	cell.setCellValue(ndDTO.getConsecutivoRdl().longValue());	
							pos_i++;
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "MttoSRMaqConsultaEstatusServicios.xlsx");
	...
	public List<Labor> getLabores() {
		if (labores == null || labores.size() == 0) {
			...
			try {	Object[] condicion = { "estado", true, "A", "=", "tipoLabor", true, "Mtto_Maquinaria_goperacion",
			"<>" };
