...
@ManagedBean
@ViewScoped
public class informePresupuestoLaboresView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(informePresupuestoLaboresView.class);
	...
	public informePresupuestoLaboresView() {
		super();
	}
		...
		if (compania != null) {
			try {
				...
				filename = servletContext.getRealPath("") + File.separator + "informes" + File.separator
						+ "PresupuestoDetallado.xlsx";

				data = businessDelegatorView.consultarInformeProyeccionLaboresLoteDet(compania, fechaInicial,
						fechaFinal, cultivosSeleccionadas, flagCultivo, zonasSeleccionadas, flagZona,
						fincasSeleccionadas, flagFinca, bloquesSeleccionadas, flagBloque, lotesSeleccionadas, flagLote,
						laboresSeleccionadas, flagLabor, unidadesMedidaSeleccionadas, flagUnidadMedida,
						grupoLaboresSeleccionadas, flagGrupoLabor, tenenciasSeleccionadas, flagTenencia,
				...
				try {
					...
					if (data != null) {
						...
						for (ProyeccionLaboresLoteDTO proyeccionLaboresLoteDTO : data) {
							...
							cell15.setCellValue(proyeccionLaboresLoteDTO.getCod_tp_recurso());
							cell15.setCellStyle(style);
							cell16.setCellValue(proyeccionLaboresLoteDTO.getNom_tp_recurso());
							cell16.setCellStyle(style);
							cell17.setCellValue(proyeccionLaboresLoteDTO.getCod_recurso());
							cell17.setCellStyle(style);
							cell18.setCellValue(proyeccionLaboresLoteDTO.getNom_recursos());
							cell18.setCellStyle(style);
							cell19.setCellValue(proyeccionLaboresLoteDTO.getUm_recurso());
							cell19.setCellStyle(style);
							cell20.setCellValue(proyeccionLaboresLoteDTO.getNom_elem_costo());
							cell20.setCellStyle(style);
							cell21.setCellValue(proyeccionLaboresLoteDTO.getFi_tarifa().toString().substring(0, 10));
							cell21.setCellStyle(style);
							cell22.setCellValue(proyeccionLaboresLoteDTO.getFf_tarifa().toString().substring(0, 10));
							cell22.setCellStyle(style);
							cell23.setCellValue(proyeccionLaboresLoteDTO.getDisponibilidad_dia().doubleValue());
							cell23.setCellStyle(style);
							cell24.setCellValue(proyeccionLaboresLoteDTO.getDisponibilidad_total().doubleValue());
							cell24.setCellStyle(style);
							cell25.setCellValue(proyeccionLaboresLoteDTO.getValor_unit_recurso().doubleValue());
							cell25.setCellStyle(style);
							cell26.setCellValue(proyeccionLaboresLoteDTO.getRendimiento_recurso().doubleValue());
							cell26.setCellStyle(style);
							cell27.setCellValue(proyeccionLaboresLoteDTO.getCantidad_presupuestada().doubleValue());
							cell27.setCellStyle(style);
							cell28.setCellValue(proyeccionLaboresLoteDTO.getValor_presupuestado().doubleValue());
							cell28.setCellStyle(style);
							cell29.setCellValue(proyeccionLaboresLoteDTO.getAnio_mes());
							cell29.setCellStyle(style);

							cell30.setCellValue(proyeccionLaboresLoteDTO.getFechaInicial().toString().substring(0, 10));
							cell30.setCellStyle(style);
							cell31.setCellValue(proyeccionLaboresLoteDTO.getFechaFinal().toString().substring(0, 10));
							cell31.setCellStyle(style);
							cell32.setCellValue(proyeccionLaboresLoteDTO.getDuracion().doubleValue());
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "PresupuestoDetallado.xlsx");
