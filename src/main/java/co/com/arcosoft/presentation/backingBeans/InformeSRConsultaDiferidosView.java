...
@ManagedBean
@ViewScoped
public class InformeSRConsultaDiferidosView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InformeSRConsultaDiferidosView.class);
	...
	private List<ConsultaCostosDiferidosDTO> data;
	...
	public InformeSRConsultaDiferidosView() {
		super();
	}
	...
	public void consultaDiferidos() throws NumberFormatException, Exception {
		...
		if (compania != null & fechaInicial !=null  & fechaFinal !=null) {
			try {
				...
				List<ConsultaCostosDiferidosDTO> data = null;
				...
				data = businessDelegator2View.pr_dat_diferidos(compania, fechaInicial, fechaFinal);
				...
				try {
					...
					if (data != null) {
						...
						cell.setCellValue("FECHA DIFERIDO");
						cell.setCellStyle(style2);
						
						cell = row.createCell(8);
						cell.setCellValue("NUMERO CUOTAS");
						cell.setCellStyle(style2);
						
						cell = row.createCell(9);
						cell.setCellValue("VALOR CUOTA");
						cell.setCellStyle(style2);
						...
						cell.setCellValue("AÑO APLICACION");
						cell.setCellStyle(style2);
						
						cell = row.createCell(12);
						cell.setCellValue("MES APLICACION");
						cell.setCellStyle(style2);
						...
						for (ConsultaCostosDiferidosDTO ndDTO : data) {
							...
							cell = row.createCell(1);
							cell.setCellValue(ndDTO.getNumeroFactura());
							...
							cell = row.createCell(4);
							cell.setCellValue(ndDTO.getCodGasto());

							cell = row.createCell(5);
							cell.setCellValue(ndDTO.getNomGasto());

							cell = row.createCell(6);
							cell.setCellValue(ndDTO.getDetalle_nota());

							cell = row.createCell(7);
						
							cell.setCellValue(
									ndDTO.getFecha_diferido().toString().substring(8, 10)+"/"+
									ndDTO.getFecha_diferido().toString().substring(5, 7)+"/"+
									ndDTO.getFecha_diferido().toString().substring(0, 4));
							
							cell = row.createCell(8);
							cell.setCellValue(ndDTO.getPeriodos().longValue());

							
							cell = row.createCell(9);
							cell.setCellValue(ndDTO.getValor_cuota().doubleValue());

							cell = row.createCell(10);
							cell.setCellValue(ndDTO.getObservacion());

							cell = row.createCell(11);
							cell.setCellValue(ndDTO.getAnio_aplicacion().longValue());
							
							
							cell = row.createCell(12);
							cell.setCellValue(ndDTO.getMes_aplicacion().longValue());
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "MttoDiferidos.xlsx");
	...
	public void consultaDiferidosEditable() {
		try {
			...
			if(compania !=null & fechaInicial !=null & fechaFinal !=null) {
			 ...
			 if(data !=null & data.size()>0) {
				for( ConsultaCostosDiferidosDTO data1 : data) {
					 
					 valorTotal += (data1.getValor_cuota().doubleValue()) ;
			        }
	...
	public List<ConsultaCostosDiferidosDTO> getData() {
		return data;
	}

	public void setData(List<ConsultaCostosDiferidosDTO> data) {
		this.data = data;
	}
