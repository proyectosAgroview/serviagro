...
@ManagedBean
@ViewScoped
public class informeCostosAgricolasView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(informeCostosAgricolasView.class);
	...
	public informeCostosAgricolasView() {
		super();
	}
	...
	public void laboresHacienda() throws NumberFormatException, Exception {
...
*/
			...
			try {
				...
				try {
					...
					//		Cell cell33 = row.createCell(32);
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "caLaboresPorHacienda.xlsx");
	...
	public void auxiliarCostosLote() throws NumberFormatException, Exception {
...
*/
			...
			try {
				...
				try {
					...
					//		Cell cell33 = row.createCell(32);
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "caAuxiliarCostosLote.xlsx");
	...
	public void resumenCostosLote() throws NumberFormatException, Exception {
...
*/
			...
			try {
				...
				try {
					...
					//		Cell cell33 = row.createCell(32);
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "caResumenCostosLote.xlsx");
	...
	public void costosLoteCentro() throws NumberFormatException, Exception {
...
*/
			...
			try {
				...
				try {
					...
					//		Cell cell33 = row.createCell(32);
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "caCostosLoteCentro.xlsx");
	...
	public void costosEdadLote() throws NumberFormatException, Exception {
		...
		Long diasLabor =  FacesUtils.checkLong(txtDiasLabor);
		if(txtHacienda.getValue()!=null) {
			idHacienda = FacesUtils.checkString(txtHacienda);
			flagFinca =0L;
		}
...
*/
			...
			try {
				...
				try {
					...
					//		Cell cell33 = row.createCell(32);
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "caCostosEdadLote.xlsx");
	...
	public void costosPorPeriodoHdaLoteLabor() throws NumberFormatException, Exception {
...
*/
		...
		if (compania != null  && fechaFinal !=null) {
			try {
				...
				filename = servletContext.getRealPath("") + File.separator + "informes" + File.separator
						+ "caCostosPorPeriodoHdaLoteLabor.xlsx";
				...
				try {
					...
					if (data != null) {
						...
						Cell	columna33	=	row.createCell(32		);	columna33.setCellValue("EDAD HOY(DIAS)");	columna33.setCellStyle(style2);
						Cell	columna34	=	row.createCell(33		);	columna34.setCellValue("EDAD HOY(MESES)");	columna34.setCellStyle(style2);
						...
						for (CostosTotalesDTO costosTotalesDTO : data) {
							...
							cell33.setCellValue(costosTotalesDTO.getEdadHoy().doubleValue());
							Double edad = costosTotalesDTO.getEdadHoy().doubleValue()/30.45;
							
							cell34.setCellValue(edad);
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "caCostosPorPeriodoHdaLoteLabor.xlsx");
	...
	public void costosResumenHdaCentro() throws NumberFormatException, Exception {
...
*/
			...
			try {
				...
				try {
					...
					if (data != null) {
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "caCostosResumenHdaCentro.xlsx");
	...
	public void costosResumenHdaLote() throws NumberFormatException, Exception {
...
*/
			...
			try {
				...
				try {
					...
					if (data != null) {
						...
						Cell	columna35	=	row.createCell(34		);	columna35.setCellValue("F. SIEMBRA");	columna35.setCellStyle(style2);
						Cell	columna36	=	row.createCell(35		);	columna36.setCellValue("F. CORTE");	columna36.setCellStyle(style2);
						...
						for (CostosTotalesDTO costosTotalesDTO : data) {
							...
							Double edadDias = costosTotalesDTO.getEdadHoy().doubleValue()*30.45;
							edadDias=(double) Math.round((edadDias) * 100) / 100;
							cell33.setCellValue(edadDias);
							cell34.setCellValue(costosTotalesDTO.getEdadHoy().doubleValue());
							
							cell35.setCellValue(costosTotalesDTO.getfSiembra());
							cell36.setCellValue(costosTotalesDTO.getfCorte());
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "caCostosResumenHdaLote.xlsx");
	...
	public void costosResumenHdaLoteCentroLabor() throws NumberFormatException, Exception {
...
*/
		...
		if (compania != null  && fechaFinal !=null) {
			try {
				...
				filename = servletContext.getRealPath("") + File.separator + "informes" + File.separator
						+ "caCostosResumenHdaLoteCentroLabor.xlsx";
				...
				try {
					...
					//		Cell cell33 = row.createCell(32);
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "caCostosResumenHdaLoteCentroLabor.xlsx");
...
*/
	...
	public void costosCentroLabor() throws NumberFormatException, Exception {
			...
			try {
				...
				try {
					...
					//		Cell cell33 = row.createCell(32);
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "caCostosCentroLabor.xlsx");
