...
@ManagedBean
@ViewScoped
public class InformeSRConsultaVencimientoEventosView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InformeSRConsultaVencimientoEventosView.class);
	...
	private List<CatalogoEquiposDTO> dataEventos;
	...
	private List<String> selectedEvento;
	...
	private CatalogoEquiposDTO selectedDatServRealizadosEquipo;
	private List<CatalogoEquiposDTO> selectedDatServRealizadosEquipo2;
	
	public InformeSRConsultaVencimientoEventosView() {
		super();
	}
	...
	public List<String> getSelectedEvento() {
		return selectedEvento;
	}

	public void setSelectedEvento(List<String> selectedEvento) {
	...
	public CatalogoEquiposDTO getSelectedDatServRealizadosEquipo() {
		return selectedDatServRealizadosEquipo;
	}

	public void setSelectedDatServRealizadosEquipo(
			CatalogoEquiposDTO selectedDatServRealizadosEquipo) {
	...
	public List<CatalogoEquiposDTO> getSelectedDatServRealizadosEquipo2() {
		return selectedDatServRealizadosEquipo2;
	}

	public void setSelectedDatServRealizadosEquipo2(
			List<CatalogoEquiposDTO> selectedDatServRealizadosEquipo2) {
	...
	public void consultaProximoEvento() {
		try {
			...
			if (selectedEvento != null && selectedEvento.size() > 0) {
				eventosSeleccionadas = selectedEvento.get(0);
				flagEquipo = 0L;
				for (int i = 1; i < selectedEvento.size(); i++) {
					eventosSeleccionadas += "," + selectedEvento.get(i);
				}
			}
			
			if(compania != null ){
					
				dataEventos = businessDelegator2View.pr_listar_eventos_equipos(compania,  equiposSeleccionadas, flagEquipo, 
	...
	public List<CatalogoEquiposDTO> getDataEventos() {
		return dataEventos;
	}

	public void setDataEventos(List<CatalogoEquiposDTO> dataEventos) {
