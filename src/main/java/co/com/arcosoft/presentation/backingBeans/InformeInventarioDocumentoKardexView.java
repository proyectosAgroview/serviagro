...
@ManagedBean
@ViewScoped
public class InformeInventarioDocumentoKardexView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InformeInventarioDocumentoKardexView.class);
	...
	public InformeInventarioDocumentoKardexView() {
		super();
	}
		...
		if (compania != null && documentoKardex !=null && conceptoKardex !=null) {
			try {
				...
				filename = servletContext.getRealPath("") + File.separator + "informes" + File.separator
						+ "MttoInventarioDocumentoKardex.xlsx";

				data = businessDelegator2View.pr_inventario_detalle( compania,  fechaFinalDateRegistro,  calendar.getTime(),
						"0",  1L, 
						"0",  1L, 
						"0",  1L,  
						conceptoKardex,   0L, documentoKardex, factura,0l,"SUMINISTROS"
						);
				...
				try {
					...
					//	}
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "MttoInventarioDocumentoKardex.xlsx");
