...
@ManagedBean
@ViewScoped
public class InformeSRMaqDistribuccionFacturacionView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InformeSRMaqDistribuccionFacturacionView.class);
	...
	public InformeSRMaqDistribuccionFacturacionView() {
		super();
	}
	...
	public void distribuccionFactura() throws NumberFormatException, Exception {
		...
		String estadoServicio = "facturado";
		...
		if (compania != null) {
			try {
				...
				filename = servletContext.getRealPath("") + File.separator + "informes" + File.separator
						+ "MttoSRDistribuccionFactura.xlsx";

				data = businessDelegator2View.pr_distribuccion_factura(compania, estadoServicio, fechaInicial, fechaFinal, 
						...
						flagUnidadMedida, grupoLaboresSeleccionadas, flagGrupoLabor, equiposSeleccionadas, flagEquipo, 0L,0L);
				...
				try {
					...
					if (data != null) {
						...
						cell = row.createCell(44	);	cell.setCellValue("FECHA FACTURA");	cell.setCellStyle(style2);
						cell = row.createCell(45	);	cell.setCellValue("DETALLE FACTURA");	cell.setCellStyle(style2);
						cell = row.createCell(46	);	cell.setCellValue("ESTATUS FACTURA");	cell.setCellStyle(style2);
						cell = row.createCell(47	);	cell.setCellValue("CONSECUTIVO RDL");	cell.setCellStyle(style2);
						int pos_i = 8;
						...
						for (ConsultaServiciosRealizadosMaquinariaDTO ndDTO : data) {
							...
							cell.setCellValue(
									ndDTO.getFechaFactura().toString().substring(8, 10)+"/"+
									ndDTO.getFechaFactura().toString().substring(5, 7)+"/"+
									ndDTO.getFechaFactura().toString().substring(0, 4));
							cell.setCellStyle(style2);
							
							cell = row.createCell(45	);	cell.setCellValue(ndDTO.getDetalleFactura());	cell.setCellStyle(style);
							cell = row.createCell(46	);	cell.setCellValue(ndDTO.getEstatusFactura());	cell.setCellStyle(style);
							cell = row.createCell(47	);	cell.setCellValue(ndDTO.getConsecutivoRdl().longValue());	cell.setCellStyle(style);
							pos_i++;
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "MttoSRDistribuccionFactura.xlsx");
