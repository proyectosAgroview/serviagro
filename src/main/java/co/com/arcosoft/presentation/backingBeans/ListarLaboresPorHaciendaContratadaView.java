...
@ManagedBean
@ViewScoped
public class ListarLaboresPorHaciendaContratadaView implements Serializable {
	private static final long serialVersionUID = 1L;
	@SuppressWarnings("unused")
	private static final Logger log = LoggerFactory.getLogger(ListarLaboresPorHaciendaContratadaView.class);
	...
	public ListarLaboresPorHaciendaContratadaView() {
		super();
	}
		...
		try {
			...
			if (compania != null && fechaInicial != null && fechaFinal != null) {
				...
				dataDetalle = businessDelegatorView.consultarInformeNominaDetallada(compania, fechaInicial, fechaFinal,
					"0", 1L, haciendasSeleccionadas, flagHacienda, "0", 1L, "0", 1L, laboresSeleccionadas, flagLabor, 
					"0", 1L, "0", 1L, "0", 1L,  contratistasSeleccionados, flagContratista, "0", 1L, "0", 0L, 1L, "0"
			...
			if (compania != null) {
				try {
					...
					filename = servletContext.getRealPath("") + File.separator + "informes" + File.separator
							+ "LaboresPorHaciendaContratista.xlsx";

					data = businessDelegatorView.consultarInformeNominaDetallada(compania, fechaInicial, fechaFinal,
						"0", 1L, haciendasSeleccionadas, flagHacienda, "0", 1L, "0", 1L, laboresSeleccionadas, flagLabor, 
						"0", 1L, "0", 1L, "0", 1L,  contratistasSeleccionados, flagContratista, "0", 1L, "0", 0L, 1L, "0","MANO DE OBRA", "Contratistas");
					...
					try {
						...
						if (data != null) {
							...
							file = new DefaultStreamedContent(stream, "application/xlsx", "LaboresPorHaciendaContratista.xlsx");
