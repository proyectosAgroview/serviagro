...
@ManagedBean
@ViewScoped
public class InformeInventarioProdSRLMaquinariaView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InformeInventarioProdSRLMaquinariaView.class);
	...
	public InformeInventarioProdSRLMaquinariaView() {
		super();
	}
		...
		if(compania != null ) {
			try {
				...
				data = businessDelegator2View.pr_inventario_detalle(compania, fechaInicial, fechaFinal, "0", 1L,
						...
						flagConceptoKardex, 0l, 0l,tipoProducto,"0");
				...
				try {
					...
					if (data != null) {
						...
						for (ConsultaCompraProductosDTO costosTotalesDTO : data) {
							...
							cell25.setCellValue(costosTotalesDTO.getCodUbicacionAlmacen());
							cell25.setCellStyle(style);
							
							cell26.setCellValue(costosTotalesDTO.getInfoAdicional());
			...
			try {
				...
				try {
					...
					if (data != null) {
						...
						Cell 	columna25	=	row.createCell(	24	);	columna25.setCellValue("CONSECUTIVO_PIN");	columna25	.setCellStyle(style2);
						Cell 	columna26	=	row.createCell(	25	);	columna26.setCellValue("ID RDL");	columna26	.setCellStyle(style2);
						...
						Cell 	columna39	=	row.createCell(	38	);	columna39.setCellValue("NOTAS");	columna39	.setCellStyle(style2);
						...
						//	cell.setCellValue(fechaI);
									...
									cell25.setCellValue(costosTotalesDTO.getPrecioProdid().longValue());cell25.setCellStyle(style);
									cell26.setCellValue(costosTotalesDTO.getDat_serv_realizados_equipo_id().longValue());cell26.setCellStyle(style);
									cell27.setCellValue(costosTotalesDTO.getConsecutivoRdlTexto());cell27.setCellStyle(style);
									...
									cell39.setCellValue(costosTotalesDTO.getInfoAdicional());cell39.setCellStyle(style);
