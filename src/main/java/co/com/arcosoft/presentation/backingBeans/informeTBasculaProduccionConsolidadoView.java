...
@ManagedBean
@ViewScoped
public class informeTBasculaProduccionConsolidadoView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(informeTBasculaProduccionConsolidadoView.class);
	...
	private List<TiquetesBasculaProduccionInformeDTO> data;
	...
	private SelectOneMenu txtTipoFecha;
	/*****************************************/
	...
	public informeTBasculaProduccionConsolidadoView() {
		super();
	}
	...
	public String exportToPyGExcel() {
		...
		String tipoFecha = (FacesUtils.checkString(txtTipoFecha));
		...
		if (compania != null && fechaInicial != null && fechaFinal != null) {
			try {
				...
				List<TiquetesBasculaProduccionInformeDTO> data = null;
				...
				filename = servletContext.getRealPath("") + File.separator + "informes" + File.separator
						+ "ConsolidadoProduccion.xlsx";

				data = businessDelegatorView.consultarTiqueteBasculaProduccionInforme(compania, fechaInicial,
						fechaFinal, equiposSeleccionadas, flagEquipo, tiquetesSeleccionados, flagTiquete,
						"0", flagZona, "0", flagFinca, "0", flagBloque,
						"0", flagLote, contratistasSeleccionadas, flagProveedor, tipoFecha);
				...
				try {
					...
					if (data != null) {
						...
						columna1.setCellValue("DAT_TRANS_PROD_ID");
						Cell columna2 = row.createCell(1);
						columna2.setCellValue("NO. TIQUETE");
						Cell columna3 = row.createCell(2);
						columna3.setCellValue("FECHA DESPACHO");
						Cell columna4 = row.createCell(3);
						columna4.setCellValue("TIPO_TRANSACCION");
						Cell columna5 = row.createCell(4);
						columna5.setCellValue("EQUIPO");
						Cell columna6 = row.createCell(5);
						columna6.setCellValue("FECHA LLEGADA");
						Cell columna7 = row.createCell(6);
						columna7.setCellValue("FECHA SALIDA");
						Cell columna8 = row.createCell(7);
						columna8.setCellValue("PESO_BRUTO");
						Cell columna9 = row.createCell(8);
						columna9.setCellValue("PESO_TARA");
						Cell columna10 = row.createCell(9);
						columna10.setCellValue("PESO_NETO");
						Cell columna11 = row.createCell(10);
						columna11.setCellValue("DESTINO_PRODUCCION");
						Cell columna12 = row.createCell(11);
						columna12.setCellValue("COMPANIA");
						Cell columna13 = row.createCell(12);
						columna13.setCellValue("TRANSPORTADORA");
						Cell columna14 = row.createCell(13);
						columna14.setCellValue("CONDUCTOR");
						Cell columna15 = row.createCell(14);
						columna15.setCellValue("OBSERVACION");
						Cell columna16 = row.createCell(15);
						columna16.setCellValue("ESTADO");
						Cell columna17 = row.createCell(16);
						columna17.setCellValue("OBSERVACION_ANULAR_REG");
						Cell columna18 = row.createCell(17);
						columna18.setCellValue("VAGON1");
						Cell columna19 = row.createCell(18);
						columna19.setCellValue("VAGON2");
						Cell columna20 = row.createCell(19);
						columna20.setCellValue("VAGON3");
						Cell columna21 = row.createCell(20);
						columna21.setCellValue("FECHA INGRESO");
						Cell columna22 = row.createCell(21);
						columna22.setCellValue("FECHA_TARA");
						Cell columna23 = row.createCell(22);
						columna23.setCellValue("FECHA_PESO_NETO");
						Cell columna24 = row.createCell(23);
						columna24.setCellValue("NUMERO_SELLOS");
						Cell columna25 = row.createCell(24);
						columna25.setCellValue("BASCULA_TARA");
						Cell columna26 = row.createCell(25);
						columna26.setCellValue("BASCULA_PESO_BRUTO");
						Cell columna27 = row.createCell(26);
						columna27.setCellValue("USUARIO_PESO_TARA");
						Cell columna28 = row.createCell(27);
						columna28.setCellValue("USUARIO_PESO_BRUTO");
						Cell columna29 = row.createCell(28);
						columna29.setCellValue("VARIABLE1");
						Cell columna30 = row.createCell(29);
						columna30.setCellValue("VARIABLE2");
						Cell columna31 = row.createCell(30);
						columna31.setCellValue("VARIABLE3");
						Cell columna32 = row.createCell(31);
						columna32.setCellValue("VARIABLE4");
						Cell columna33 = row.createCell(32);
						columna33.setCellValue("VARIABLE5");
						Cell columna34 = row.createCell(33);
						columna34.setCellValue("VARIABLE6");
						Cell columna35 = row.createCell(34);
						columna35.setCellValue("VARIABLE7");
						Cell columna36 = row.createCell(35);
						columna36.setCellValue("VARIABLE8");
						Cell columna37 = row.createCell(36);
						columna37.setCellValue("VARIABLE9");
						Cell columna38 = row.createCell(37);
						columna38.setCellValue("VARIABLE10");
						Cell columna39 = row.createCell(38);
						columna39.setCellValue("OBSERVACION_ANALISIS");
						Cell columna40 = row.createCell(39);
						columna40.setCellValue("FECHA_ANULACION");
						Cell columna41 = row.createCell(40);
						columna41.setCellValue("LOTE");
						Cell columna42 = row.createCell(41);
						columna42.setCellValue("PRODUCTO");
						Cell columna43 = row.createCell(42);
						columna43.setCellValue("NOMBRECOMPANIA");
						Cell columna44 = row.createCell(43);
						columna44.setCellValue("NITCOMPANIA");
						Cell columna45 = row.createCell(44);
						columna45.setCellValue("TELEFONOCOMPANIA");
						Cell columna46 = row.createCell(45);
						columna46.setCellValue("DIRECCIONCOMPANIA");
						Cell columna47 = row.createCell(46);
						columna47.setCellValue("CIUDADCOMPANIA");
						Cell columna48 = row.createCell(47);
						columna48.setCellValue("ZONA");
						Cell columna49 = row.createCell(48);
						columna49.setCellValue("FINCA");
						Cell columna50 = row.createCell(49);
						columna50.setCellValue("BLOQUE");
						Cell columna51 = row.createCell(50);
						columna51.setCellValue("VARIEDAD");
						Cell columna52 = row.createCell(51);
						columna52.setCellValue("PESOPROMEDIO");
						Cell columna53 = row.createCell(52);
						columna53.setCellValue("PRODUCCIONLOTE");
						Cell columna54 = row.createCell(53);
						columna54.setCellValue("AREA");
						Cell columna55 = row.createCell(54);
						columna55.setCellValue("MES");
						Cell columna56 = row.createCell(55);
						columna56.setCellValue("MES_CORTO");
						Cell columna57 = row.createCell(56);
						columna57.setCellValue("AÑO");
						Cell columna58 = row.createCell(57);
						columna58.setCellValue("COSTO TOTAL");
						Cell columna59 = row.createCell(58);
						columna59.setCellValue("PROVEEDOR");
						Cell columna60 = row.createCell(59);
						columna60.setCellValue("TENENCIA");
						Cell columna61 = row.createCell(60);
						columna61.setCellValue("CATEGORIA VEHICULO");
						Cell columna62 = row.createCell(61);
						columna62.setCellValue("REG_DESPACHO");
						Cell columna63 = row.createCell(62);
						columna63.setCellValue("ESTADO_ALMACENADO");
						Cell columna64 = row.createCell(63);
						columna64.setCellValue("TIEMPO DE ESPERA");
						Cell columna65 = row.createCell(64);
						columna65.setCellValue("TIEMPO DESCARGUE");
						Cell columna66 = row.createCell(65);
						columna66.setCellValue("TIEMPO TOTAL");
						Cell columna67 = row.createCell(66);
						columna67.setCellValue("CONSECUTIVO ANALISIS FRUTO");
						Cell columna68 = row.createCell(67);
						columna68.setCellValue("DESC. X IMPUREZAS");
						Cell columna69 = row.createCell(68);
						columna69.setCellValue("DESC. X PODRIDO");
						Cell columna70 = row.createCell(69);
						columna70.setCellValue("% M");
						Cell columna71 = row.createCell(70);
						columna71.setCellValue("% V");
						Cell columna72 = row.createCell(71);
						columna72.setCellValue("% S.M");
						Cell columna73 = row.createCell(72);
						columna73.setCellValue("% P");
						Cell columna74 = row.createCell(73);
						columna74.setCellValue("% P.L");
						Cell columna75 = row.createCell(74);
						columna75.setCellValue("RACIMOS_MAL_FORMADOS");
						Cell columna76 = row.createCell(75);
						columna76.setCellValue("RANGO DE IMPUREZAS");
						Cell columna77 = row.createCell(76);
						columna77.setCellValue("% RAC DEMOTISPA");
						Cell columna78 = row.createCell(77);
						columna78.setCellValue("TOTAL ANA (%)");
						Cell columna79 = row.createCell(78);
						columna79.setCellValue("CALIFICADOR");
						Cell columna80 = row.createCell(79);
						columna80.setCellValue("DOCUMENTO INTERNO DE PESAJE");
						Cell columna81 = row.createCell(80);
						columna81.setCellValue("FECHA EN PORTERIA");
						...
						columna59.setCellStyle(style2);
						columna60.setCellStyle(style2);
						columna61.setCellStyle(style2);
						columna62.setCellStyle(style2);
						columna63.setCellStyle(style2);
						columna64.setCellStyle(style2);
						columna65.setCellStyle(style2);
						columna66.setCellStyle(style2);
						columna67.setCellStyle(style2);
						columna68.setCellStyle(style2);
						columna69.setCellStyle(style2);
						columna70.setCellStyle(style2);
						columna71.setCellStyle(style2);
						columna72.setCellStyle(style2);
						columna73.setCellStyle(style2);
						columna74.setCellStyle(style2);
						columna75.setCellStyle(style2);
						columna76.setCellStyle(style2);
						columna77.setCellStyle(style2);
						columna78.setCellStyle(style2);
						columna79.setCellStyle(style2);
						columna80.setCellStyle(style2);
						columna81.setCellStyle(style2);

						int pos_i = 5;

						for (TiquetesBasculaProduccionInformeDTO ndDTO : data) {

							row = sheet.createRow(pos_i);
							Cell cell1 = row.createCell(0);
							cell1.setCellValue(ndDTO.getDat_trans_prod_id().doubleValue());
							Cell cell2 = row.createCell(1);
							cell2.setCellValue(ndDTO.getConsecutivo().doubleValue());
							Cell cell3 = row.createCell(2);
							cell3.setCellValue(ndDTO.getFecha_registro().toString().substring(0, 10));
							Cell cell4 = row.createCell(3);
							cell4.setCellValue(ndDTO.getTipo_transaccion());
							Cell cell5 = row.createCell(4);
							cell5.setCellValue(ndDTO.getEquipo());
							Cell cell6 = row.createCell(5);
							cell6.setCellValue(ndDTO.getFecha_entrada().toString().substring(0, 10));
							Cell cell7 = row.createCell(6);
							cell7.setCellValue(ndDTO.getFecha_salida().toString().substring(0, 10));
							Cell cell8 = row.createCell(7);
							cell8.setCellValue(ndDTO.getPeso_bruto().doubleValue());
							Cell cell9 = row.createCell(8);
							cell9.setCellValue(ndDTO.getPeso_tara().doubleValue());
							Cell cell10 = row.createCell(9);
							cell10.setCellValue(ndDTO.getPeso_neto().doubleValue());
							Cell cell11 = row.createCell(10);
							cell11.setCellValue(ndDTO.getDestino_produccion());
							Cell cell12 = row.createCell(11);
							cell12.setCellValue(ndDTO.getCompania().doubleValue());
							Cell cell13 = row.createCell(12);
							cell13.setCellValue(ndDTO.getTransportadora());
							Cell cell14 = row.createCell(13);
							cell14.setCellValue(ndDTO.getConductor());
							Cell cell15 = row.createCell(14);
							cell15.setCellValue(ndDTO.getObservacion());
							Cell cell16 = row.createCell(15);
							cell16.setCellValue(ndDTO.getEstado());
							Cell cell17 = row.createCell(16);
							cell17.setCellValue(ndDTO.getObservacion_anular_reg());
							Cell cell18 = row.createCell(17);
							cell18.setCellValue(ndDTO.getVagon1());
							Cell cell19 = row.createCell(18);
							cell19.setCellValue(ndDTO.getVagon2());
							Cell cell20 = row.createCell(19);
							cell20.setCellValue(ndDTO.getVagon3());
							Cell cell21 = row.createCell(20);
							cell21.setCellValue(ndDTO.getFecha_peso_bruto().toString().substring(0, 10));
							Cell cell22 = row.createCell(21);
							cell22.setCellValue(ndDTO.getFecha_tara().toString().substring(0, 10));
							Cell cell23 = row.createCell(22);
							cell23.setCellValue(ndDTO.getFecha_peso_neto().toString().substring(0, 10));
							Cell cell24 = row.createCell(23);
							cell24.setCellValue(ndDTO.getNumero_sellos());
							Cell cell25 = row.createCell(24);
							cell25.setCellValue(ndDTO.getBascula_tara());
							Cell cell26 = row.createCell(25);
							cell26.setCellValue(ndDTO.getBascula_peso_bruto());
							Cell cell27 = row.createCell(26);
							cell27.setCellValue(ndDTO.getUsuario_peso_tara());
							Cell cell28 = row.createCell(27);
							cell28.setCellValue(ndDTO.getUsuario_peso_bruto());
							Cell cell29 = row.createCell(28);
							cell29.setCellValue(ndDTO.getAcidez().doubleValue());
							Cell cell30 = row.createCell(29);
							cell30.setCellValue(ndDTO.getHumedad().doubleValue());
							Cell cell31 = row.createCell(30);
							cell31.setCellValue(ndDTO.getImpurezas().doubleValue());
							Cell cell32 = row.createCell(31);
							cell32.setCellValue(ndDTO.getVariable4().doubleValue());
							Cell cell33 = row.createCell(32);
							cell33.setCellValue(ndDTO.getVariable5().doubleValue());
							Cell cell34 = row.createCell(33);
							cell34.setCellValue(ndDTO.getVariable6().doubleValue());
							Cell cell35 = row.createCell(34);
							cell35.setCellValue(ndDTO.getVariable7().doubleValue());
							Cell cell36 = row.createCell(35);
							cell36.setCellValue(ndDTO.getVariable8().doubleValue());
							Cell cell37 = row.createCell(36);
							cell37.setCellValue(ndDTO.getVariable9().doubleValue());
							Cell cell38 = row.createCell(37);
							cell38.setCellValue(ndDTO.getVariable10().doubleValue());
							Cell cell39 = row.createCell(38);
							cell39.setCellValue(ndDTO.getObservacion_analisis());
							Cell cell40 = row.createCell(39);
							cell40.setCellValue(ndDTO.getFecha_anulacion());
							Cell cell41 = row.createCell(40);
							cell41.setCellValue(ndDTO.getLote());
							Cell cell42 = row.createCell(41);
							cell42.setCellValue(ndDTO.getProducto());
							Cell cell43 = row.createCell(42);
							cell43.setCellValue(ndDTO.getNombreCompania());
							Cell cell44 = row.createCell(43);
							cell44.setCellValue(ndDTO.getNitCompania());
							Cell cell45 = row.createCell(44);
							cell45.setCellValue(ndDTO.getTelefonoCompania());
							Cell cell46 = row.createCell(45);
							cell46.setCellValue(ndDTO.getDireccionCompania());
							Cell cell47 = row.createCell(46);
							cell47.setCellValue(ndDTO.getCiudadCompania());
							Cell cell48 = row.createCell(47);
							cell48.setCellValue(ndDTO.getZona());
							Cell cell49 = row.createCell(48);
							cell49.setCellValue(ndDTO.getFinca());
							Cell cell50 = row.createCell(49);
							cell50.setCellValue(ndDTO.getBloque());
							Cell cell51 = row.createCell(50);
							cell51.setCellValue(ndDTO.getVariedad());
							Cell cell52 = row.createCell(51);
							cell52.setCellValue(ndDTO.getPesoPromedio().doubleValue());
							Cell cell53 = row.createCell(52);
							cell53.setCellValue(ndDTO.getProduccionLote().doubleValue());
							Cell cell54 = row.createCell(53);
							cell54.setCellValue(ndDTO.getAreaCosechada().doubleValue());
							Cell cell55 = row.createCell(54);
							cell55.setCellValue(ndDTO.getMes().doubleValue());
							Cell cell56 = row.createCell(55);
							cell56.setCellValue(ndDTO.getMesCorto());
							Cell cell57 = row.createCell(56);
							cell57.setCellValue(ndDTO.getAnio().doubleValue());
							Cell cell58 = row.createCell(57);
							cell58.setCellValue(ndDTO.getCostoTotal().doubleValue());
							Cell cell59 = row.createCell(58);
							cell59.setCellValue(ndDTO.getProveedor());
							Cell cell60 = row.createCell(59);
							cell60.setCellValue(ndDTO.getTenencia());
							Cell cell61 = row.createCell(60);
							cell61.setCellValue(ndDTO.getCateg_equipo());
							Cell cell62 = row.createCell(61);
							cell62.setCellValue(ndDTO.getReg_despacho());
							Cell cell63 = row.createCell(62);
							cell63.setCellValue(ndDTO.getEstado_almacenado());
							Cell cell64 = row.createCell(63);
							cell64.setCellValue(ndDTO.getTiempo_espera_hr().doubleValue());
							Cell cell65 = row.createCell(64);
							cell65.setCellValue(ndDTO.getTiempo_descargue_hr().doubleValue());
							Cell cell66 = row.createCell(65);
							cell66.setCellValue(ndDTO.getTiempo_total_hr().doubleValue());
							Cell cell67 = row.createCell(66);
							cell67.setCellValue(ndDTO.getNum_consecutivo_analisis().doubleValue());
							Cell cell68 = row.createCell(67);
							cell68.setCellValue(ndDTO.getDescuento_impurezas().doubleValue());
							Cell cell69 = row.createCell(68);
							cell69.setCellValue(ndDTO.getDescuento_rac_podrido().doubleValue());
							Cell cell70 = row.createCell(69);
							cell70.setCellValue(ndDTO.getRacimos_maduros().doubleValue());
							Cell cell71 = row.createCell(70);
							cell71.setCellValue(ndDTO.getRacimos_verdes().doubleValue());
							Cell cell72 = row.createCell(71);
							cell72.setCellValue(ndDTO.getRacimos_sobremaduros().doubleValue());
							Cell cell73 = row.createCell(72);
							cell73.setCellValue(ndDTO.getRacimos_podridos().doubleValue());
							Cell cell74 = row.createCell(73);
							cell74.setCellValue(ndDTO.getRacimos_pend_largo().doubleValue());
							Cell cell75 = row.createCell(74);
							cell75.setCellValue(ndDTO.getRacimos_mal_formados().doubleValue());
							Cell cell76 = row.createCell(75);
							cell76.setCellValue(ndDTO.getPorc_racimos().doubleValue());
							Cell cell77 = row.createCell(76);
							cell77.setCellValue(ndDTO.getRango_impurezas().doubleValue());
							Cell cell78 = row.createCell(77);
							cell78.setCellValue(ndDTO.getRa_demotispa().doubleValue());
							Cell cell79 = row.createCell(78);
							cell79.setCellValue(ndDTO.getUsuarioAnalisis());							
							Cell cell80 = row.createCell(79);
							cell80.setCellValue(ndDTO.getConsecutivo_peso_neto().longValue());
							Cell cell81 = row.createCell(80);
							cell81.setCellValue(ndDTO.getFecha_vehiculo_porteria().toString().substring(0, 10));
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "ConsolidadoProduccion.xlsx");
	...
	public List<TiquetesBasculaProduccionInformeDTO> getData() {
		try {
			if (data == null) {
				data = businessDelegatorView.consultarTiqueteBasculaProduccionInforme(1L, null, null, null, null, null,
	...
	public SelectOneMenu getTxtTipoFecha() {
		return txtTipoFecha;
	}

	public void setTxtTipoFecha(SelectOneMenu txtTipoFecha) {
		this.txtTipoFecha = txtTipoFecha;
	}
