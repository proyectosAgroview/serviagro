...
@ManagedBean
@ViewScoped
public class informeSalidaInsumosAlmacenView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(informeSalidaInsumosAlmacenView.class);
	...
	public informeSalidaInsumosAlmacenView() {
		super();
	}
	...
	public String exportToPyGExcel() {
		...
		if (compania != null) {
			try {
				List<DetalleInsumosLoteDTO> data = null;
				...
				filename = servletContext.getRealPath("") + File.separator + "informes" + File.separator
						+ "salidasInsumosAlmacen.xlsx";

				data = businessDelegatorView.consultaDetalleInsumosLoteDTO(
						compania, tiposProductoSeleccionadas, flagTipoProducto,
				...
				try {
					...
					if (data != null) {
						...
						for (DetalleInsumosLoteDTO reporteDTO : data) {
							...
							cell1.setCellValue(reporteDTO.getNomTipoProducto());
							cell2.setCellValue(reporteDTO.getCodProducto());
							cell3.setCellValue(reporteDTO.getNomProducto());
							cell4.setCellValue(reporteDTO.getNombreUdadMed());
							cell5.setCellValue(reporteDTO.getAlmacen());
							cell6.setCellValue(reporteDTO.getFechaMovimiento().toString().substring(0,10));
							cell7.setCellValue(reporteDTO.getCantidadIngresada().doubleValue());
							cell8.setCellValue(reporteDTO.getCantidadSalida().doubleValue());
							cell9.setCellValue(reporteDTO.getLote());
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "salidasInsumosAlmacen.xlsx");
	...
	public List<DetalleInsumosLoteDTO> getData() {
		try {
			if (data == null) {
				data = businessDelegatorView.consultaDetalleInsumosLoteDTO(null, null, null, null, null, null,
						null, null, null);
			}
		} catch (Exception e) {
			e.printStackTrace();
