...
@ManagedBean
@ViewScoped
public class ListarCostosGastosPorHaciendaView implements Serializable {
	private static final long serialVersionUID = 1L;
	@SuppressWarnings("unused")
	private static final Logger log = LoggerFactory.getLogger(ListarCostosGastosPorHaciendaView.class);
	...
	public ListarCostosGastosPorHaciendaView() {
		super();
	}
	...
	public void listarPlanillaNominaDetallada() {
		try {
			...
			if (compania != null && fechaInicial != null && fechaFinal != null) {
				...
				dataDetalle = businessDelegator2View.pr_costos_detallado(compania, fechaInicial, fechaFinal, "0", 1L, 
					haciendasSeleccionadas, flagHacienda, "0", 1L, lotesSeleccionados, flagLote, "0", 1L, 0L, "0");
			}
			...
			if (compania != null) {
				try {
					...
					filename = servletContext.getRealPath("") + File.separator + "informes" + File.separator
							+ "CostosGastosPorHacienda.xlsx";

					data = businessDelegator2View.pr_costos_detallado(compania, fechaInicial, fechaFinal, "0", 1L, 
						haciendasSeleccionadas, flagHacienda, "0", 1L, lotesSeleccionados, flagLote, "0", 1L, 0L, "0");
					...
					try {
						...
						if (data != null) {
							...
							file = new DefaultStreamedContent(stream, "application/xlsx", "CostosGastosPorHacienda.xlsx");
