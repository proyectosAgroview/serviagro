...
@ManagedBean
@ViewScoped
public class DatAnaLabCalidadFrutoPalma2View implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(DatAnaLabCalidadFrutoPalma2View.class);
	...
	public DatAnaLabCalidadFrutoPalma2View() {
		super();
	}
	...
	public String action_clear() throws ParseException {
		...
		if (txtHoraDigitacion != null) {
			...
			Date hora = null;
			hora = dateFormat.parse("01/01/2018 06:00");
			txtHoraDigitacion.setValue(hora);
		...
		if (nivel4Tiquete == null || nivel4Tiquete.size() == 0) {
			try {
				...
				if(txtTiquete.getValue() !=null){
					 consecutivo = FacesUtils.checkLong(txtTiquete);
