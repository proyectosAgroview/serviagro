...
@ManagedBean
@ViewScoped
public class InformeSRServiciosMaquinaView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InformeSRServiciosMaquinaView.class);
	...
	public InformeSRServiciosMaquinaView() {
		super();
	}
	...
	public void consultaServiciosMaquina() {
		try {
