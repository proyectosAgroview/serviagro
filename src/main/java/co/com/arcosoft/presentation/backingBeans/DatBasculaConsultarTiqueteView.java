...
@ManagedBean
@ViewScoped
public class DatBasculaConsultarTiqueteView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(DatBasculaConsultarTiqueteView.class);
	...
	public DatBasculaConsultarTiqueteView() {
		super();
	}
	...
	public String action_savePesoTara() {
		try {
			...
			businessDelegatorView.updateDatTransProd(entity, dataDetTransProductos, dataDetTransNivel4, dataPlanillaDet);
