...
@ManagedBean
@ViewScoped
public class InformeSRCostoHrMaqView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InformeSRCostoHrMaqView.class);
	...
	public InformeSRCostoHrMaqView() {
		super();
	}
	...
	public void consultaCostoHoraMaquina() {
		try {
