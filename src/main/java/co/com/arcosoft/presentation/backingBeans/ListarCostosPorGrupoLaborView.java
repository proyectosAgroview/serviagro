...
@ManagedBean
@ViewScoped
public class ListarCostosPorGrupoLaborView implements Serializable {
	private static final long serialVersionUID = 1L;
	@SuppressWarnings("unused")
	private static final Logger log = LoggerFactory.getLogger(ListarCostosPorGrupoLaborView.class);
	...
	public ListarCostosPorGrupoLaborView() {
		super();
	}
	...
	public void listarPlanillaNominaDetallada() {
		try {
			...
			if (compania != null && fechaInicial != null && fechaFinal != null) {
				...
				dataDetalle = businessDelegator2View.pr_costos_resumen_labor_grupo(compania, fechaInicial, fechaFinal, "0", 1L, 
			...
			if (compania != null) {
				try {
					...
					filename = servletContext.getRealPath("") + File.separator + "informes" + File.separator
							+ "CostosPorGrupoLabor.xlsx";

					data = businessDelegator2View.pr_costos_resumen_labor_grupo(compania, fechaInicial, fechaFinal, "0", 1L, 
						haciendasSeleccionadas, flagHacienda, "0", 1L, lotesSeleccionados, flagLote, "0", 1L, 0L, "0");
					...
					try {
						...
						if (data != null) {
							...
							file = new DefaultStreamedContent(stream, "application/xlsx", "CostosPorGrupoLabor.xlsx");
