...
@ManagedBean
@ViewScoped
public class informeProgramaLaboresDetView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(informeProgramaLaboresDetView.class);
	...
	private List<ProgramacionLaboresDTO> data;
	...
	public informeProgramaLaboresDetView() {
		super();
	}
	...
	public String exportToPyGExcel() {
		...
		if (compania != null) {
			try {
				...
				List<ProgramacionLaboresDTO> data = null;
				...
				filename = servletContext.getRealPath("") + File.separator + "informes" + File.separator
						+ "ProgramaLabores.xlsx";

				data = businessDelegatorView.consultarInformeProgramacionLabores(compania, fechaInicial, fechaFinal,
						...
						flagGrupoLabor, trabajadorSeleccionadas, flagTrabajador);
				...
				try {
					...
					if (data != null) {
						...
						for (ProgramacionLaboresDTO ndDTO : data) {
							...
							cell1.setCellValue(ndDTO.getOrdenTrabajo().longValue());
							cell1.setCellStyle(style3);
							cell2.setCellValue(ndDTO.getPeriodoInicial().toString().substring(0, 10));
							cell2.setCellStyle(style3);
							cell3.setCellValue(ndDTO.getPeriodoFinal().toString().substring(0, 10));
							cell3.setCellStyle(style3);

							if (ndDTO.getFechaRealizado().toString().substring(0, 10).equals("1969-12-01")) {
								cell4.setCellValue("");
							} else {
								cell4.setCellValue(ndDTO.getFechaRealizado().toString().substring(0, 10));
							}
							cell4.setCellStyle(style3);
							cell5.setCellValue(ndDTO.getCodLabor());
							cell5.setCellStyle(style3);
							cell6.setCellValue(ndDTO.getNombreLabor());
							cell6.setCellStyle(style3);
							cell7.setCellValue(ndDTO.getCodZona());
							cell7.setCellStyle(style3);
							cell8.setCellValue(ndDTO.getCodFinca());
							cell8.setCellStyle(style3);
							cell9.setCellValue(ndDTO.getNomFinca());
							cell9.setCellStyle(style3);
							cell10.setCellValue(ndDTO.getCodBloque());
							cell10.setCellStyle(style3);
							cell11.setCellValue(ndDTO.getLoteA());
							cell11.setCellStyle(style3);
							cell12.setCellValue(ndDTO.getNomLote());
							cell12.setCellStyle(style3);
							cell13.setCellValue(ndDTO.getArea().doubleValue());
							cell13.setCellStyle(style3);
							cell14.setCellValue(ndDTO.getPlantas().doubleValue());
							cell14.setCellStyle(style3);
							cell15.setCellValue(ndDTO.getCantidadPlan().doubleValue());
							cell15.setCellStyle(style3);
							cell16.setCellValue(ndDTO.getNombreUdadMed());
							cell16.setCellStyle(style3);
							cell17.setCellValue(ndDTO.getNombreSupervisor());
							cell17.setCellStyle(style3);
							cell18.setCellValue(ndDTO.getRendimientoMO().doubleValue());
							cell18.setCellStyle(style3);
							cell19.setCellValue(ndDTO.getRendimientoMQ().doubleValue());
							cell19.setCellStyle(style3);
							cell20.setCellValue(ndDTO.getConsumoAcpm().doubleValue());
							cell20.setCellStyle(style3);
							cell21.setCellValue(ndDTO.getEstadoOt());
							cell21.setCellStyle(style3);
							cell22.setCellValue(ndDTO.getObservacion());
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "ProgramaLabores.xlsx");
	...
	public List<ProgramacionLaboresDTO> getData() {
		try {
			if (data == null) {
				data = businessDelegatorView.consultarInformeProgramacionLabores(1L, null, null, null, null, null, null,
	...
	public void setData(List<ProgramacionLaboresDTO> data) {
		this.data = data;
	}
