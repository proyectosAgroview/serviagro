...
@ManagedBean
@ViewScoped
public class InformeSRPyGMaquinariaConsolidadoView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InformeSRPyGMaquinariaConsolidadoView.class);
	...
	public InformeSRPyGMaquinariaConsolidadoView() {
		super();
	}
