...
@ManagedBean
@ViewScoped
public class InformeSuministroReposicionMaquinariaView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InformeSuministroReposicionMaquinariaView.class);
	...
	public InformeSuministroReposicionMaquinariaView() {
		super();
	}
		...
		if (compania != null) {
			try {
				...
				filename = servletContext.getRealPath("") + File.separator + "informes" + File.separator
						+ "MttoSuministrosReposicion.xlsx";

				data = businessDelegator2View.pr_suministros_para_reposicion( compania,  tiposProductoSeleccionadas,  flagTipoProducto,
					 	productosSeleccionadas,  flagProducto			 );
				...
				try {
					...
					if (data != null) {
						...
						columna1.setCellValue("TIPO DE PRODUCTO");
						columna1.setCellStyle(style2);
						Cell columna2 = row.createCell(1);
						columna2.setCellValue("COD. PRODUCTO");
						...
						for (ConsultaStockMaquinariaDTO costosTotalesDTO : data) {
							...
							cell1.setCellValue(costosTotalesDTO.getNomTipoProducto());
							cell1.setCellStyle(style);
							cell2.setCellValue(costosTotalesDTO.getCodProducto());
							cell2.setCellStyle(style);
							cell3.setCellValue(costosTotalesDTO.getNomProducto());
							cell3.setCellStyle(style);
							cell4.setCellValue(costosTotalesDTO.getNombreUdadMed());
							cell4.setCellStyle(style);
							cell5.setCellValue(costosTotalesDTO.getSaldoMinimo().doubleValue());
							cell5.setCellStyle(style);
							cell6.setCellValue(costosTotalesDTO.getCantidadDisponible().doubleValue());
							cell6.setCellStyle(style);
						 
							cell7.setCellValue(costosTotalesDTO.getCantidadPedido());
							cell7.setCellStyle(style);
							cell8.setCellValue(costosTotalesDTO.getReferencia());
					...
					//	}
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "MttoSuministrosReposicion.xlsx");
	...
	public List<ConsultaStockMaquinariaDTO> getData() {
		try {
			if (data == null) {
				data = businessDelegator2View.pr_suministros_para_reposicion( null, null, null, null, null );
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
