...
@ManagedBean
@ViewScoped
public class InformeSRCostosTotalesConceptoPagoMaquinariaView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InformeSRCostosTotalesConceptoPagoMaquinariaView.class);
	...
	public InformeSRCostosTotalesConceptoPagoMaquinariaView() {
		super();
	}
	...
	public void consultaCostosTotalesConceptoPago() {
		try {
