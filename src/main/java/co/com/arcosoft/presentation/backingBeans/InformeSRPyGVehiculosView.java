...
@ManagedBean
@ViewScoped
public class InformeSRPyGVehiculosView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InformeSRPyGVehiculosView.class);
	...
	public InformeSRPyGVehiculosView() {
		super();
	}
		...
		try {
			...
			if(compania != null && fechaInicial != null && fechaFinal != null){
				...
				data = businessDelegator2View.pr_pyg_equipo(compania,  fechaInicial, fechaFinal, 
					 equiposSeleccionadas, flagEquipo,categoriaEquiposSeleccionadas, flagEquipoCategoriaEquipos, estadoServicio,0l);
