...
@ManagedBean
@ViewScoped
public class InformeConsultaStockAlmacenMaquinariaView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InformeConsultaStockAlmacenMaquinariaView.class);
	...
	public InformeConsultaStockAlmacenMaquinariaView() {
		super();
	}
	...
	public void consultaStock() {
		try {
			...
			if (compania != null) {
				...
				data = businessDelegatorView.consultaStockMaquinaria(compania, tiposProductoSeleccionadas, flagTipoProducto,
