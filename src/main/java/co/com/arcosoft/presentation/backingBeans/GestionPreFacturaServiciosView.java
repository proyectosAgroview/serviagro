...
@ManagedBean
@ViewScoped
public class GestionPreFacturaServiciosView implements Serializable {
    private static final long serialVersionUID = 1L;
    private static final Logger log = LoggerFactory.getLogger(GestionPreFacturaServiciosView.class);
    ...
    public GestionPreFacturaServiciosView() {
        super();
    }
...
//            entity.setDatFacturaServiciosId(datFacturaServiciosId);
			...
			{	
				if(valor_factura>0){
					 businessDelegator2View.actualizarNumFacturaEnDatServRDet(cadenaFactura, num_factura);
