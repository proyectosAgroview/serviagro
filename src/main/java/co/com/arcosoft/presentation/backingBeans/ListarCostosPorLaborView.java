...
@ManagedBean
@ViewScoped
public class ListarCostosPorLaborView implements Serializable {
	private static final long serialVersionUID = 1L;
	@SuppressWarnings("unused")
	private static final Logger log = LoggerFactory.getLogger(ListarCostosPorLaborView.class);
	...
	public ListarCostosPorLaborView() {
		super();
	}
				...
				try {
					...
					try {
						...
						if (data != null) {
							...
							cell = row.createCell(2); cell.setCellStyle(style2); cell.setCellValue("NOMBRE LABOR");
							cell = row.createCell(3); cell.setCellStyle(style2); cell.setCellValue("FECHA");
							cell = row.createCell(4); cell.setCellStyle(style2); cell.setCellValue("UNIDAD");
							cell = row.createCell(5); cell.setCellStyle(style2); cell.setCellValue("CANTIDAD");
							...
							cell = row.createCell(8); cell.setCellStyle(style2); cell.setCellValue("DOCUMENTO");
							cell = row.createCell(9); cell.setCellStyle(style2); cell.setCellValue("REGISTRO");
							...
							for (CostosTotalesDTO ndDTO : data) {
								...
								cell = row.createCell(2); cell.setCellValue(ndDTO.getNombreLabor());
								...
								cell = row.createCell(4); cell.setCellValue(ndDTO.getCodUdadMedCos());
								cell = row.createCell(5); cell.setCellValue(ndDTO.getCantidadPago().doubleValue());
								...
								cell = row.createCell(8); cell.setCellValue(ndDTO.getId().longValue());
