...
@ManagedBean
@ViewScoped
public class InformeSRPyGMaquinariaView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InformeSRPyGMaquinariaView.class);
	...
	public InformeSRPyGMaquinariaView() {
		super();
	}
