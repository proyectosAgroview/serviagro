...
@ManagedBean
@ViewScoped
public class informeAnalisisEnfermedadesVer2View implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(informeAnalisisEnfermedadesVer2View.class);
	...
	private List<AnalisisEnfermedadVer2DTO> data;
	...
	public informeAnalisisEnfermedadesVer2View() {
		super();
	}
	...
	public String exportToPyGExcel() {
		...
		if (compania != null) {
			try {
				List<AnalisisEnfermedadVer2DTO> data = null;
				...
				data = businessDelegatorView.consultarAnalisisEnfermedadVer2(compania, fechaInicial, fechaFinal,
				...
				try {
					...
					if (data != null) {
						...
						columna4.setCellValue("ENFERMEDAD");
						...
						columna10.setCellValue("LINEA");

						Cell columna11 = row.createCell(10);
						columna11.setCellValue("PALMA");

						Cell columna12 = row.createCell(11);
						columna12.setCellValue("GRADO SEVERIDAD");

						Cell columna13 = row.createCell(12);
						columna13.setCellValue("EVOLUCION");

						Cell columna14 = row.createCell(13);
						columna14.setCellValue("N° CENSO");

						Cell columna15 = row.createCell(14);
						columna15.setCellValue("PROCEDIMIENTO");

						Cell columna16 = row.createCell(15);
						columna16.setCellValue("UBICACION");

						Cell columna17 = row.createCell(16);
						columna17.setCellValue("CASOS");
						
						Cell columna18 = row.createCell(17);
						columna18.setCellValue("LONGITUD");

						Cell columna19 = row.createCell(18);
						columna19.setCellValue("LATITUD");

						int pos_i = 5;

						for (AnalisisEnfermedadVer2DTO costosTotalesDTO : data) {
							...
							cell4.setCellValue(costosTotalesDTO.getNombreEnfermedad());
							...
							cell10.setCellValue(costosTotalesDTO.getLinea().doubleValue());
							cell11.setCellValue(costosTotalesDTO.getPlanta().doubleValue());

							cell12.setCellValue(costosTotalesDTO.getGradoSeveridad().doubleValue());
							cell13.setCellValue(costosTotalesDTO.getEvolucion());
							cell14.setCellValue(costosTotalesDTO.getNumCenso().doubleValue());
							cell15.setCellValue(costosTotalesDTO.getProcedimiento());
							cell16.setCellValue(costosTotalesDTO.getUbicacion());
							cell17.setCellValue(1L);
							cell18.setCellValue(costosTotalesDTO.getLongitud());
							cell19.setCellValue(costosTotalesDTO.getLatitud());
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "ENFERMEDADES.xlsx");
	...
	public List<AnalisisEnfermedadVer2DTO> getData() {
		try {
			if (data == null) {
				data = businessDelegatorView.consultarAnalisisEnfermedadVer2(null, null, null, null, null, null, null,
