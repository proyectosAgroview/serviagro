...
@ManagedBean
@ViewScoped
public class informeInsumosAgricolasExcelView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(informeInsumosAgricolasExcelView.class);
	...
	private List<CostosInsumosDetalladoDTO> data;
	...
	public informeInsumosAgricolasExcelView() {
		super();
	}
		...
		if (compania != null) {
			try {
				...
				data = businessDelegatorView.consultarInformeCostosInsumosDetallado(compania, fechaInicial, fechaFinal,
						...
						flagTenencia, productosSeleccionadas, flagProducto, 0L);
				...
				try {
					...
					if (data != null) {
						...
						columna11.setCellValue("PRODUCTO");
						Cell columna12 = row.createCell(11);
						columna12.setCellValue("UNIDAD DE MEDIDA");
						Cell columna13 = row.createCell(12);
						columna13.setCellValue("AREA/PLANTAS");
						Cell columna14 = row.createCell(13);
						columna14.setCellValue("DOSIS");
						Cell columna15 = row.createCell(14);
						columna15.setCellValue("CANTIDAD APLICADA");
						Cell columna16 = row.createCell(15);
						columna16.setCellValue("VALOR UNITARIO");
						Cell columna17 = row.createCell(16);
						columna17.setCellValue("COSTO TOTAL");
						Cell columna18 = row.createCell(17);
						columna18.setCellValue("AÑO-MES");
						Cell columna19 = row.createCell(18);
						columna19.setCellValue("ES GENERICO");

						Cell columna20 = row.createCell(19);
						columna20.setCellValue("FECHA INICIAL REPORTE");

						Cell columna21 = row.createCell(20);
						columna21.setCellValue("FECHA FIN REPORTE");

						int pos_i = 1;

						for (CostosInsumosDetalladoDTO costosTotalesDTO : data) {
							...
							cell4.setCellValue(costosTotalesDTO.getNomZona());
							...
							cell11.setCellValue(costosTotalesDTO.getNomProducto());
							cell12.setCellValue(costosTotalesDTO.getCodUdadMedAplic());
							cell13.setCellValue(costosTotalesDTO.getAreaAplicada().doubleValue());
							cell14.setCellValue(costosTotalesDTO.getDosis().doubleValue());
							cell15.setCellValue(costosTotalesDTO.getCantidadAplicada().doubleValue());
							cell16.setCellValue(costosTotalesDTO.getValorUnit().doubleValue());
							cell17.setCellValue(costosTotalesDTO.getCostoTotal().doubleValue());
							cell18.setCellValue(costosTotalesDTO.getMesCorto());
							cell19.setCellValue(costosTotalesDTO.getGenerico());
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "InsumosAplicados.xlsx");
	...
	public List<CostosInsumosDetalladoDTO> getData() {
		try {
			if (data == null) {
				data = businessDelegatorView.consultarInformeCostosInsumosDetallado(null, null, null, null, null, null,
