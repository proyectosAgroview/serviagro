...
@ManagedBean
@ViewScoped
public class InformeSRLiqAuxilioProductividadView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InformeSRLiqAuxilioProductividadView.class);
	...
	public InformeSRLiqAuxilioProductividadView() {
		super();
	}
	...
	public void impimirirAuxilioProductividad() {
		...
		if (compania != null) {
			try {
				...
				filename = servletContext.getRealPath("") + File.separator + "informes" + File.separator
						+ "MttoSRImprimeLiqAuxilioP.xlsx";
				
				data = businessDelegator2View.pr_liq_auxilio_productividad(compania,  fechaInicial, fechaFinal, 
				...
				try {
					...
					if (data != null) {
						...
						cell = row.createCell(6	);	cell.setCellValue("SALARIO");	cell.setCellStyle(style2);
						cell = row.createCell(7	);	cell.setCellValue("BONIFICACION TRABAJADOR");	cell.setCellStyle(style2);
						cell = row.createCell(8	);	cell.setCellValue("DEVENGO BASE");	cell.setCellStyle(style2);
						cell = row.createCell(9	);	cell.setCellValue("DEVEGO TOTAL");	cell.setCellStyle(style2);
						cell = row.createCell(10	);	cell.setCellValue("AUXILIO DE PRODUCTIVIDAD");	cell.setCellStyle(style2);
						cell = row.createCell(11	);	cell.setCellValue("CARGO");	cell.setCellStyle(style2);
						cell = row.createCell(12	);	cell.setCellValue("DIAS LABORADOS");	cell.setCellStyle(style2);
						...
						for (ConsultaServiciosRealizadosMaquinariaDTO ndDTO : data) {
							...
							cell = row.createCell(6	);	cell.setCellValue(ndDTO.getSalario().doubleValue());	cell.setCellStyle(style);
							cell = row.createCell(7	);	cell.setCellValue(ndDTO.getBonificacion_trabajador().doubleValue());	cell.setCellStyle(style);
							cell = row.createCell(8	);	cell.setCellValue(ndDTO.getValorDia().doubleValue());	cell.setCellStyle(style);
							cell = row.createCell(9	);	cell.setCellValue(ndDTO.getDevengo().doubleValue());	cell.setCellStyle(style);
							cell = row.createCell(10	);	cell.setCellValue(ndDTO.getAuxilio_productividad().doubleValue());	cell.setCellStyle(style);
							cell = row.createCell(11	);	cell.setCellValue(ndDTO.getNom_profesion());	cell.setCellStyle(style);
							cell = row.createCell(12	);	cell.setCellValue(ndDTO.getDiasLaborados().doubleValue());	cell.setCellStyle(style);
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "MttoSRImprimeLiqAuxilioP.xlsx");
