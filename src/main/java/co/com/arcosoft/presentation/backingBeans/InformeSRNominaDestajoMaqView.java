...
@ManagedBean
@ViewScoped
public class InformeSRNominaDestajoMaqView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InformeSRNominaDestajoMaqView.class);
	...
	private List<ConsultaComprobantePagoDTO> data;
	...
	public InformeSRNominaDestajoMaqView() {
		super();
	}
	...
	public void imprimirNominaDestajoMaq() throws NumberFormatException, Exception {
		...
		if(txtTipoNomina.getValue()!=null) {
			tipoNomina = FacesUtils.checkString(txtTipoNomina);
		}
		...
		if (compania != null && fechaInicial != null && fechaInicial !=null) {
			try {
				...
				List<ConsultaComprobantePagoDTO> data = null;
				...
				filename = servletContext.getRealPath("") + File.separator + "informes" + File.separator
						+ "MttoSRNominaDestajoMaq.xlsx";
				
				data = businessDelegator2View.pr_comprobante_pago_nomina_maq_destajo(compania,  fechaInicial, fechaFinal, 
							operadorSeleccionadas, flagOperador, tipoNomina);
				...
				try {
					...
					if (data != null) {
						...
						cell = row.createCell(0	);	cell.setCellValue("FECHA");	cell.setCellStyle(style2);
						cell = row.createCell(1);	cell.setCellValue("PERIODO LIQUIDACION");	cell.setCellStyle(style2);
						cell = row.createCell(2	);	cell.setCellValue("COD OPERARIO");	cell.setCellStyle(style2);
						cell = row.createCell(3	);	cell.setCellValue("NOM OPERARIO");	cell.setCellStyle(style2);
						cell = row.createCell(4	);	cell.setCellValue("NOM CONCEPTO NOMINA");	cell.setCellStyle(style2);
						cell = row.createCell(5	);	cell.setCellValue("TIPO MOVIMIENTO");	cell.setCellStyle(style2);
						cell = row.createCell(6	);	cell.setCellValue("DEVENGOS");	cell.setCellStyle(style2);
						cell = row.createCell(7	);	cell.setCellValue("DESCUENTOS");	cell.setCellStyle(style2);
						cell = row.createCell(8);	cell.setCellValue("HORAS");	cell.setCellStyle(style2);
						cell = row.createCell(9);	cell.setCellValue("HACIENDA");	cell.setCellStyle(style2);
						cell = row.createCell(10);	cell.setCellValue("LOTE");	cell.setCellStyle(style2);
						cell = row.createCell(11);	cell.setCellValue("COD. LABOR");	cell.setCellStyle(style2);
						cell = row.createCell(12);	cell.setCellValue("LABOR");	cell.setCellStyle(style2);
						cell = row.createCell(13);	cell.setCellValue("UNIDAD MEDIDA");	cell.setCellStyle(style2);
						cell = row.createCell(14);	cell.setCellValue("VR. UNITARIO");	cell.setCellStyle(style2);
						cell = row.createCell(15);	cell.setCellValue("PROFESION");	cell.setCellStyle(style2);
						cell = row.createCell(16);	cell.setCellValue("HAS");	cell.setCellStyle(style2);
						cell = row.createCell(17);	cell.setCellValue("ID MÁQUINA");	cell.setCellStyle(style2);
						cell = row.createCell(18);	cell.setCellValue("MÁQUINA");	cell.setCellStyle(style2);
						cell = row.createCell(19);	cell.setCellValue("CONSECUTIVO");	cell.setCellStyle(style2);
						cell = row.createCell(20);	cell.setCellValue("CONSECUTIVO RDL");	cell.setCellStyle(style2);
						cell = row.createCell(21);	cell.setCellValue("TURNO");	cell.setCellStyle(style2);
						cell = row.createCell(22);	cell.setCellValue("CENTRO COSTO");	cell.setCellStyle(style2);
						int pos_i = 8;

						for (ConsultaComprobantePagoDTO ndDTO : data) {

							row = sheet.createRow(pos_i);
							DateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
							String fecha = "";
							if(ndDTO.getFecha_registro()!=null) {
								fecha = dateFormat.format(ndDTO.getFecha_registro());
							}
							cell = row.createCell(0	);	cell.setCellValue(fecha);	cell.setCellStyle(style);
							...
							cell = row.createCell(2	);	cell.setCellValue(ndDTO.getCod_operario());	cell.setCellStyle(style);
							cell = row.createCell(3	);	cell.setCellValue(ndDTO.getNom_operario());	cell.setCellStyle(style);
							cell = row.createCell(4	);	cell.setCellValue(ndDTO.getNom_concepto_nomina());	cell.setCellStyle(style);
							cell = row.createCell(5	);	cell.setCellValue(ndDTO.getTipoMovimiento());	cell.setCellStyle(style);
							cell = row.createCell(6	);	cell.setCellValue(ndDTO.getDevengo().doubleValue());	cell.setCellStyle(style);
							cell = row.createCell(7	);	cell.setCellValue(ndDTO.getDescuentos().doubleValue());	cell.setCellStyle(style);
							
							cell = row.createCell(8	);	cell.setCellValue(ndDTO.getHoras_horometro().doubleValue());	cell.setCellStyle(style);
							cell = row.createCell(9	);	cell.setCellValue(ndDTO.getNom_hacienda());	cell.setCellStyle(style);
							cell = row.createCell(10	);	cell.setCellValue(ndDTO.getCod_lote());	cell.setCellStyle(style);
							cell = row.createCell(11	);	cell.setCellValue(ndDTO.getCod_labor());	cell.setCellStyle(style);
							cell = row.createCell(12	);	cell.setCellValue(ndDTO.getNom_labor());	cell.setCellStyle(style);
							cell = row.createCell(13	);	cell.setCellValue(ndDTO.getUnidadMedida());	cell.setCellStyle(style);
							cell = row.createCell(14	);	cell.setCellValue(ndDTO.getValor_unitario_trabajador().doubleValue());	cell.setCellStyle(style);
							cell = row.createCell(15);	cell.setCellValue(ndDTO.getNom_profesion());	cell.setCellStyle(style);
							cell = row.createCell(16);	cell.setCellValue(ndDTO.getCantidad_pago().doubleValue());	cell.setCellStyle(style);
							
							cell = row.createCell(17);	cell.setCellValue(ndDTO.getCodEquipo());	cell.setCellStyle(style);
							cell = row.createCell(18);	cell.setCellValue(ndDTO.getNomEquipo());	cell.setCellStyle(style);
							cell = row.createCell(19);	cell.setCellValue(ndDTO.getConsecutivo().longValue());	cell.setCellStyle(style);
							cell = row.createCell(20);	cell.setCellValue(ndDTO.getConsecutivoRdl().longValue());	cell.setCellStyle(style);
							cell = row.createCell(21);	cell.setCellValue(ndDTO.getTurno());	cell.setCellStyle(style);
							cell = row.createCell(22);	cell.setCellValue(ndDTO.getNomCentroCosto());	cell.setCellStyle(style);
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "MttoSRNominaDestajoMaq.xlsx");
	...
	public void imprimirNominaDestajoMaqFiltroTrabajador() throws NumberFormatException, Exception {
		...
		if (compania != null && fechaInicial != null && fechaInicial !=null && txtTrabajador.getValue()!=null) {
			try {
				...
				filename = servletContext.getRealPath("") + File.separator + "informes" + File.separator
						+ "MttoSRNominaDestajoMaqResumen.xlsx";
				
				data = businessDelegator2View.pr_comprobante_pago_nomina_maq_destajo(compania,  fechaInicial, fechaFinal, 
						IdTrabajador, 0L,tipoNomina);
				...
				try {
					...
					if (data != null) {
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "MttoSRNominaDestajoMaqResumen.xlsx");
	...
	public void comprobantesPagoMaq() throws NumberFormatException, Exception {
		...
		if (compania != null && fechaInicial != null && fechaInicial !=null) {
			try {
				...
				List<ConsultaComprobantePagoDTO> data1 = null;
				InputStream stream = null;
				String filename = " ";
				...
				filename = servletContext.getRealPath("") + File.separator + "informes" + File.separator
						+ "MttoComprobantesPagoMaq.xlsx";
				
				data1 = businessDelegator2View.pr_comprobante_pago_nomina(compania,  fechaInicial, fechaFinal, 
				...
				try {
					...
					if (data1 != null) {
						...
						for (ConsultaComprobantePagoDTO ndDTO : data1) {
							...
							cell = row.createCell(2	);	cell.setCellValue(ndDTO.getPeriodoLiquidacion());	cell.setCellStyle(style);
							...
							cell = row.createCell(5	);	cell.setCellValue(ndDTO.getNom_concepto_nomina());	cell.setCellStyle(style);
							...
							cell = row.createCell(8	);	cell.setCellValue(ndDTO.getDescuentos().doubleValue());	cell.setCellStyle(style);
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "MttoComprobantesPagoMaq.xlsx");
	...
	public List<ConsultaComprobantePagoDTO> getData() {
		try {
			if (data == null) {
				data = businessDelegator2View.pr_comprobante_pago_nomina(null, null, null, null, null);
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void setData(List<ConsultaComprobantePagoDTO> data) {
		this.data = data;
	}
	...
	public void imprimirNominaDestajoMaqCompleta() throws NumberFormatException, Exception {
		...
		if (compania != null && fechaInicial != null && fechaInicial !=null) {
			try {
				...
				filename = servletContext.getRealPath("") + File.separator + "informes" + File.separator
						+ "MttoSRNominaDestajoMaqCompleta.xlsx";
				
				data = businessDelegator2View.pr_comprobante_pago_nomina_maq_destajo2(compania,  fechaInicial, fechaFinal, 
							operadorSeleccionadas, flagOperador, tipoNomina);
				...
				try {
					...
					if (data != null) {
						...
						file = new DefaultStreamedContent(stream, "application/xlsx", "MttoSRNominaDestajoMaqCompleta.xlsx");
