...
@ManagedBean
@ViewScoped
public class InformeSRCombustibleMaqView implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(InformeSRCombustibleMaqView.class);
	...
	public InformeSRCombustibleMaqView() {
		super();
	}
	...
	public void consultaConsumoCombustible() {
		try {
