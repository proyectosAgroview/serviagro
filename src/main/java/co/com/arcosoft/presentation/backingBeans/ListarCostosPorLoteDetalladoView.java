...
@ManagedBean
@ViewScoped
public class ListarCostosPorLoteDetalladoView implements Serializable {
	private static final long serialVersionUID = 1L;
	@SuppressWarnings("unused")
	private static final Logger log = LoggerFactory.getLogger(ListarCostosPorLoteDetalladoView.class);
	...
	public ListarCostosPorLoteDetalladoView() {
		super();
	}
				...
				try {
					...
					try {
						...
						if (data != null) {
							...
							cell = row.createCell(1); cell.setCellStyle(style2); cell.setCellValue("CONCEPTO");
							cell = row.createCell(2); cell.setCellStyle(style2); cell.setCellValue("CANTIDAD");
							...
							cell = row.createCell(6); cell.setCellStyle(style2); cell.setCellValue("DOCUMENTO");
							cell = row.createCell(7); cell.setCellStyle(style2); cell.setCellValue("REGISTRO");
							...
							for (CostosTotalesDTO ndDTO : data) {
								...
								cell = row.createCell(1); cell.setCellValue(ndDTO.getNombreElementoCosto());
								cell = row.createCell(2); cell.setCellValue(ndDTO.getCantidadPago().doubleValue());
								cell = row.createCell(3); cell.setCellValue(ndDTO.getCodUdadMedPago());
								...
								cell = row.createCell(6); cell.setCellValue(ndDTO.getId().longValue());
								cell = row.createCell(7); cell.setCellValue(ndDTO.getIdDetalle().longValue());
							...
							file = new DefaultStreamedContent(stream, "application/xlsx", "CostoPorLotesDetallado.xlsx");
