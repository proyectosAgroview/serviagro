		...
		//	SimpleDateFormat anio = new SimpleDateFormat("yyyy");
			...
			if (compania != null && fechaInicial !=null && fechaFinal !=null) {
					 ...
					 FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, 
							"El proceso de re-calcular los ingresos de los operarios de máquinaria (RDL) fue ejecutado con éxito. ",
							""));
			...
			FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, 
					"La interfaz esta fallando, válidar con el personal de soporte de AgroView ",
					""));
