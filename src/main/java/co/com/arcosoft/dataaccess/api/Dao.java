...
public interface Dao<T, PK extends Serializable> {
	...
	/**
	 * Busca un objeto por una propiedad con valor de tipo string. Este metodo
	 * es util para buscar por columnas que poseen valores unicos.
	 *
	 * @param property
	 * @param value
	 * @return
	...
	/**
	 * Busca por igual todas las entidades que tienen una propertyName con el
	 * valor id. Permite buscar por un identificador en una columna de tipo
	 * Long.
	 *
	 * @param propertyName
	 *            : nombre de la propiedad por la cual filtrar.
	...
	/**
	 * Devuelve la cantidad de registros asociados al metodo
	 * findAllByTextFilter.
	 *
	 * @param propertyName
	 * @param text
