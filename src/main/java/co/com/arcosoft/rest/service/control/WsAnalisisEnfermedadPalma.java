...
public class WsAnalisisEnfermedadPalma {

	private static final Logger logger = LoggerFactory.getLogger(WsAnalisisEnfermedadPalma.class);
	...
	@RequestMapping(value = "/guardarAnalisisEnfermedadPalma", method = RequestMethod.POST)
	public @ResponseBody ResponseEntity<String> guardarAnalisisEnfermedadPalma(@RequestBody SanidadVegetal sanidad) throws Exception {
		...
		if (sanidad != null) {
			...
			tipoAnalisis = businessDelegatorView.getAnaSanVeg(3l);  
			...
			detDto.setVariableText1(sanidad.getVariableText1());
			detDto.setVariable4(1.0);
			...
			return new ResponseEntity<String>(
					"El registro Censo de Enfermedades fue crado en AgroView consecutivo: (" + consecutivo.toString() + ")",
					HttpStatus.CREATED);

		} else {

			return new ResponseEntity<String>("No se encontró datos para grabar en AgroView Web (Censo enfermedades)",
