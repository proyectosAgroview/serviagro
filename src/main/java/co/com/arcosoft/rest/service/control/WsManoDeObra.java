...
public class WsManoDeObra {

	private static final Logger logger = LoggerFactory.getLogger(WsManoDeObra.class);
	...
	@RequestMapping(value = "/guardarManodeobra", method = RequestMethod.POST)
	public ResponseEntity<String> guardarManodeobra(@RequestBody ManoDeObra manoobra) throws Exception {
		...
		if (manoobra != null) {
			...
			Long ultimoId = businessDelegatorView.consultarUltimaPlanillaNomina(manoobra.getCompania(), fechaFinalDateRegistro);
			
			if(ultimoId != 0){
				
				Object[] condicion = { "planillaNominaId", true, ultimoId, "=" };
				List<DatPlanillaNomina> lista = (ultimoId != null)
						? businessDelegatorView.findByCriteriaInDatPlanillaNomina(condicion, null, null) : null;
				...
				businessDelegatorView.updateDatPlanillaNomina(entity, dataPlanillaDet,null,null,null,null);	
