...
public class DatPluvioDTO {
	...
	private String fechaPrecipitacion;
	...
	public String getFechaPrecipitacion() {
		return fechaPrecipitacion;
	}

	public void setFechaPrecipitacion(String fechaPrecipitacion) {
