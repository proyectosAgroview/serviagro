...
public class Insumos {
	...
	private String productoId_Producto;
	private Long udadMedId_UdadMed;
	private Long idPlanLaborDet;

	public Long getIdPlanLaborDet() {
		return idPlanLaborDet;
	}

	public void setIdPlanLaborDet(Long idPlanLaborDet) {
		this.idPlanLaborDet = idPlanLaborDet;
	}
	...
	public String getProductoId_Producto() {
		return productoId_Producto;
	}

	public void setProductoId_Producto(String productoId_Producto) {
