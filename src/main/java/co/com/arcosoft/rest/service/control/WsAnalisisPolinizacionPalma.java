...
public class WsAnalisisPolinizacionPalma {

	private static final Logger logger = LoggerFactory.getLogger(WsAnalisisPolinizacionPalma.class);
	...
	@RequestMapping(value = "/guardarAnalisisPolinizacionPalma", method = RequestMethod.POST)
	public @ResponseBody ResponseEntity<String> guardarAnalisisPolinizacionPalma(@RequestBody SanidadVegetal sanidad) throws Exception {
		...
		if (sanidad != null) {
			...
			tipoAnalisis = businessDelegatorView.getAnaSanVeg(7l);  
			...
			detDto.setVariable4(sanidad.getVariable4());
			...
			return new ResponseEntity<String>(
					"El registro del Análisis de Polinización fue crado en AgroView consecutivo: (" + consecutivo.toString() + ")",
					HttpStatus.CREATED);

		} else {

			return new ResponseEntity<String>("No se encontró datos para grabar en AgroView Web (Análisis de Polinización)",
