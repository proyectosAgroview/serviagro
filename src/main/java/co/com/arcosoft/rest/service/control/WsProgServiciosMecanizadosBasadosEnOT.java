...
public class WsProgServiciosMecanizadosBasadosEnOT {

	private static final Logger logger = LoggerFactory.getLogger(WsProgServiciosMecanizadosBasadosEnOT.class);
	...
	@RequestMapping(value = "/listarProgServiciosMecanizadosBasadosEnOT", method = RequestMethod.GET, produces = "application/json")
